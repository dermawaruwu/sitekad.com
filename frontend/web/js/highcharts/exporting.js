  ...
  h(f, "mixins/navigation.js", [], function() {
    return {
      ...
      addUpdate: function(c, f) {
        ...
        f.navigation.updates.push({ update: c, context: f });
      }
    };
  });
  h(
    ...
    [f["parts/Globals.js"], f["mixins/navigation.js"]],
    function(c, f) {
      ...
      c.post = function(b, a, c) {
        var d = r(
          "form",
          p({ method: "post", action: b, enctype: "multipart/form-data" }, c),
          { display: "none" },
          n.body
        );
        F(a, function(a, b) {
      ...
      y(A.prototype, {
        sanitizeSVG: function(b, a) {
          ...
          a &&
            ...
            (b = b.replace("\x3c/svg\x3e", d + "\x3c/svg\x3e")));
          b = b
            .replace(/zIndex="[^"]+"/g, "")
        ...
        getSVG: function(b) {
          ...
          d =
            k.exporting.sourceWidth ||
            k.chart.width ||
            (/px$/.test(d) && parseInt(d, 10)) ||
            (k.isGantt ? 800 : 600);
          m =
            k.exporting.sourceHeight ||
            k.chart.height ||
          ...
          b &&
            ["xAxis", "yAxis", "series"].forEach(function(d) {
              var c = {};
        ...
        getSVGForExport: function(b, a) {
          ...
          return this.getSVG(
            p({ chart: { borderRadius: 0 } }, c.chartOptions, a, {
              exporting: {
        ...
        print: function() {
          function b(b) {
            (a.fixedDiv
              ? [a.fixedDiv, a.scrollingContainer]
              : [a.container]
            ).forEach(function(a) {
              b.appendChild(a);
            });
          ...
          if (!a.isPrinting) {
            ...
            D(a, "beforePrint");
            if ((e = m && a.chartWidth > m))
              (k = [a.options.chart.width, void 0, !1]),
        ...
        contextMenu: function(b, a, u, d, f, m, k) {
          ...
          g ||
            ...
            (p = r("div", { className: "highcharts-menu" }, null, g)),
            e.styledMode ||
              w(
                p,
                y(
            ...
            a.forEach(function(a) {
              "string" === typeof a &&
                (a = e.options.exporting.menuItemDefinitions[a]);
              if (c.isObject(a, !0)) {
                var b;
                a.separator
                  ? (b = r("hr", null, null, p))
            ...
            e.exportDivElements.push(p, g),
            (e.exportMenuWidth = g.offsetWidth),
            (e.exportMenuHeight = g.offsetHeight));
          a = { display: "block" };
          u + e.exportMenuWidth > l
            ? (a.right = l - u - f - B + "px")
            : (a.left = u - B + "px");
          d + m + e.exportMenuHeight > q &&
        ...
        addButton: function(b) {
          ...
          if (!1 !== d.enabled) {
            var l = d.theme,
              ...
              g;
            a.styledMode ||
              ((l.fill = t(l.fill, "#ffffff")),
              (l.stroke = t(l.stroke, "none")));
            delete l.states;
            f
              ? (g = function(b) {
                  b && b.stopPropagation();
            ...
            d.text && d.symbol
              ? (l.paddingLeft = t(l.paddingLeft, 25))
              : d.text ||
                y(l, { width: d.width, height: d.height, padding: 0 });
            a.styledMode ||
              ((l["stroke-linecap"] = "round"),
              (l.fill = t(l.fill, "#ffffff")),
              (l.stroke = t(l.stroke, "none")));
            e = c
              .button(d.text, 0, 0, g, l, n, q)
              .addClass(b.className)
              .attr({
                title: t(a.options.lang[d._titleKey || d.titleKey], "")
              });
            e.menuClassName =
              b.menuClassName || "highcharts-menu-" + a.btnCount++;
            d.symbol &&
              ((k = c
            ...
            e.add(a.exportingGroup).align(
              y(d, { width: e.width, x: t(d.x, a.buttonOffset) }),
              !0,
              "spacingBox"
            );
            a.buttonOffset +=
              (e.width + d.buttonSpacing) * ("right" === d.align ? -1 : 1);
          ...
          b &&
            (b.forEach(function(b, d) {
              b &&
                ...
                (h = "cache-" + b.menuClassName),
                a[h] && delete a[h],
                (a.exportSVGElements[d] = b.destroy()));
            }),
            (b.length = 0));
          a.exportingGroup &&
            (a.exportingGroup.destroy(), delete a.exportingGroup);
          f &&
      ...
      A.prototype.inlineStyles = function() {
        ...
        function a(c) {
          function u(a, g) {
            ...
            for (r = f.length; r-- && !q; )
              q = f[r].test(g) || "function" === typeof a;
            q ||
              (m[g] === a && "svg" !== c.nodeName) ||
              e[c.nodeName][g] === a ||
              (-1 !== d.indexOf(g)
                ? c.setAttribute(b(g), a)
                : (n += b(g) + ":" + a + ";"));
          }
          var g,
            m,
          ...
          if (1 === c.nodeType && -1 === k.indexOf(c.nodeName)) {
            ...
            m =
              "svg" === c.nodeName
                ? {}
                : z.getComputedStyle(c.parentNode, null);
            e[c.nodeName] ||
              ((x = l.getElementsByTagName("svg")[0]),
              (t = l.createElementNS(c.namespaceURI, c.nodeName)),
              x.appendChild(t),
              (e[c.nodeName] = p(z.getComputedStyle(t, null))),
              "text" === c.nodeName && delete e.text.fill,
              x.removeChild(t));
            if (L || K) for (var w in g) u(g[w], w);
            else F(g, u);
            n &&
              ((g = c.getAttribute("style")),
              c.setAttribute("style", (g ? g + ";" : "") + n));
        ...
        l.open();
        l.write(
          '\x3csvg xmlns\x3d"http://www.w3.org/2000/svg"\x3e\x3c/svg\x3e'
        );
        l.close();
      ...
      I.menuball = function(b, a, c, d) {
        ...
        d = d / 3 - 2;
        return (b = b.concat(
          this.circle(c - d, a, d, d),
          this.circle(c - d, a + d + 4, d, d),
          this.circle(c - d, a + 2 * (d + 4), d, d)
        ));
      };

...
(function(Q, K) {
  "object" === typeof module && module.exports
    ? ((K["default"] = K), (module.exports = Q.document ? K(Q) : K))
  ...
  K(G, "parts/Utilities.js", [G["parts/Globals.js"]], function(a) {
    ...
    a.error = function(k, e, q) {
      var t = a.isNumber(k)
          ? "Highcharts error #" + k + ": www.highcharts.com/errors/" + k
          : k,
        u = function() {
          if (e) throw Error(t);
    ...
    a.Fx.prototype = {
      dSetter: function() {
        ...
        if (1 === t) q = this.toD;
          ...
          for (; u--; )
            (v = parseFloat(a[u])),
              (q[u] = isNaN(v) ? e[u] : t * parseFloat(e[u] - v) + v);
        else q = e;
      ...
      update: function() {
        ...
        if (this[e + "Setter"]) this[e + "Setter"]();
          ...
          a.attr
            ? a.element && a.attr(e, q, null, !0)
            : (a.style[e] = q + this.unit);
        t && t.call(a, q, this);
      },
      run: function(k, e, q) {
        var t = this,
        ...
        k !== e || this.elem["forceAnimate:" + this.prop]
          ? ((this.startTime = +new Date()),
            ...
            (v.elem = this.elem),
            (v.prop = this.prop),
            v() && 1 === a.timers.push(v) && p(h))
          : (delete u.curAnim[this.prop],
            u.complete &&
              0 === Object.keys(u.curAnim).length &&
      ...
      step: function(k) {
        ...
        u.attr && !u.element
          ...
          ? ((this.now = this.end),
            ...
            q && v && v.call(u),
            (k = !1))
          : ((this.pos = t.easing((e - this.startTime) / p)),
      ...
      initPath: function(k, e, q) {
        ...
        function u(a, d) {
          for (; a.length < g; ) {
            ...
            w &&
              ((n = a.slice(a.length - b)),
              [].splice.apply(a, [a.length, 0].concat(n)),
              c--);
          }
          a[0] = "M";
        }
        function v(a, c) {
          for (var d = (g - a.length) / b; 0 < d && d--; )
            (l = a.slice().splice(a.length / z - b, b * z)),
              (l[0] = c[g - b - d * b]),
              m && ((l[b - 6] = l[b - 2]), (l[b - 5] = l[b - 1])),
              [].splice.apply(a, [a.length / z, 0].concat(l)),
              w && d--;
        }
        e = e || "";
        var p,
      ...
      var k,
        ...
        u = function(e, p) {
          ...
          a.objectEach(p, function(h, d) {
            !a.isObject(h, !0) || a.isClass(h) || a.isDOMElement(h)
              ? (e[d] = p[d])
              : (e[d] = u(e[d] || {}, h));
          });
          return e;
    ...
    a.pad = function(a, e, q) {
      return (
        Array((e || 2) + 1 - String(a).replace("-", "").length).join(q || 0) + a
      );
    };
    a.relativeLength = function(a, e, q) {
      return /%$/.test(a)
        ? (e * parseFloat(a)) / 100 + (q || 0)
        : parseFloat(a);
    };
    ...
    a.datePropsToTimestamps = function(k) {
      a.objectEach(k, function(e, q) {
        a.isObject(e) && "function" === typeof e.getTime
          ? (k[q] = e.getTime())
          : (a.isObject(e) || a.isArray(e)) && a.datePropsToTimestamps(e);
      });
    };
        ...
        ? ((q = (q = k.match(t)) ? q[1] : -1),
          null !== e &&
            (e = a.numberFormat(
              ...
              q,
              u.decimalPoint,
              -1 < k.indexOf(",") ? u.thousandsSep : ""
            )))
        : (e = (q || a.time).dateFormat(k, e));
      return e;
    };
    ...
    a.normalizeTickInterval = function(k, e, q, t, u) {
      ...
      for (
        ...
        t < e.length &&
        !((p = e[t]),
        (u && p * q >= k) || (!u && v <= (e[t] + (e[t + 1] || e[t])) / 2));
        t++
      );
      return (p = a.correctFloat(
        p * q,
    ...
    a.numberFormat = function(k, e, q, t) {
      ...
      -1 === e
        ...
        ? e &&
          ...
          ((p = e + +d[1]),
          0 <= p
            ? ((d[0] = (+d[0]).toExponential(p).split("e")[0]), (e = p))
            : ((d[0] = d[0].split(".")[0] || 0),
              (k = 20 > e ? (d[0] * Math.pow(10, d[1])).toFixed(e) : 0),
              (d[1] = 0)))
        : (e = 2);
      h = (
        Math.abs(d[1] ? d[0] : k) + Math.pow(10, -Math.max(e, v) - 1)
      ).toFixed(e);
      v = String(a.pInt(h));
    ...
    a.getStyle = function(k, e, q) {
      ...
      if ("height" === e)
        return Math.max(
          0,
          Math.min(k.offsetHeight, k.scrollHeight) -
            a.getStyle(k, "padding-top") -
            a.getStyle(k, "padding-bottom")
        );
      F.getComputedStyle || a.error(27, !0);
      if ((k = F.getComputedStyle(k, void 0)))
        (k = k.getPropertyValue(e)),
          a.pick(q, "opacity" !== e) && (k = a.pInt(k));
      return k;
    };
    ...
    a.stop = function(k, e) {
      for (var q = a.timers.length; q--; )
        a.timers[q].elem !== k ||
          (e && e !== a.timers[q].prop) ||
          (a.timers[q].stopped = !0);
    };
    a.objectEach = function(a, e, q) {
      for (var k in a) a.hasOwnProperty(k) && e.call(q || a[k], a[k], k, a);
    };
    a.objectEach(
      {
        map: "map",
    ...
    a.addEvent = function(k, e, q, t) {
      ...
      a.Point &&
        k instanceof a.Point &&
        k.series &&
        k.series.chart &&
        (k.series.chart.runTrackerClick = !0);
      v && v.call(k, e, q, !1);
      u[e] || (u[e] = []);
      u[e].push(q);
      t &&
    ...
    a.fireEvent = function(k, e, q, t) {
      var u, v, p, h, d;
      q = q || {};
      I.createEvent && (k.dispatchEvent || k.fireEvent)
        ? ((u = I.createEvent("Events")),
          u.initEvent(e, !0, !0),
          a.extend(u, q),
          k.dispatchEvent ? k.dispatchEvent(u) : k.fireEvent(e, u))
        : ["protoEvents", "hcEvents"].forEach(function(m) {
            if (k[m])
              for (
                v = k[m][e] || [],
                  p = v.length,
    ...
    a.animate = function(k, e, q) {
      ...
      a.isObject(q) ||
        ((h = arguments),
        (q = { duration: h[2], easing: h[3], complete: h[4] }));
      ...
      a.objectEach(e, function(d, h) {
        ...
        v = null;
        "d" === h
          ? ((p.paths = p.initPath(k, k.d, e.d)),
            (p.toD = e.d),
            (t = 0),
            (v = 1))
          : k.attr
          ? (t = k.attr(h))
          : ((t = parseFloat(a.getStyle(k, h)) || 0),
            "opacity" !== h && (u = "px"));
        v || (v = d);
    ...
    F.jQuery &&
      (F.jQuery.fn.highcharts = function() {
        ...
        if (this[0])
          return k[0]
            ? (new a[a.isString(k[0]) ? k.shift() : "Chart"](
                this[0],
                k[0],
                k[1]
              ),
  ...
  K(G, "parts/Color.js", [G["parts/Globals.js"]], function(a) {
    ...
    a.Color.prototype = {
      ...
      init: function(k) {
        ...
        if (
          (this.input = k =
            this.names[k && k.toLowerCase ? k.toLowerCase() : ""] || k) &&
          k.stops
        )
          this.stops = k.stops.map(function(e) {
          ...
          (k &&
            ...
            7 === e
              ? (q = [(k & 16711680) >> 16, (k & 65280) >> 8, k & 255, 1])
              : 4 === e &&
                (q = [
                  ((k & 3840) >> 4) | ((k & 3840) >> 8),
                  ((k & 240) >> 4) | (k & 240),
      ...
      get: function(a) {
        ...
        this.stops
          ? ((t = I(e)),
            ...
            this.stops.forEach(function(e, k) {
      ...
      tweenTo: function(a, e) {
        ...
        t.length && k && k.length
          ? ((a = 1 !== t[3] || 1 !== k[3]),
            (e =
              (a ? "rgba(" : "rgb(") +
              Math.round(t[0] + (k[0] - t[0]) * (1 - e)) +
              "," +
              Math.round(t[1] + (k[1] - t[1]) * (1 - e)) +
              "," +
              Math.round(t[2] + (k[2] - t[2]) * (1 - e)) +
              (a ? "," + (t[3] + (k[3] - t[3]) * (1 - e)) : "") +
              ")"))
          : (e = a.input || "none");
        return e;
  ...
  K(G, "parts/SvgRenderer.js", [G["parts/Globals.js"]], function(a) {
    ...
    b(C.prototype, {
      ...
      complexColor: function(y, f, b) {
        ...
        a.fireEvent(
          ...
          function() {
            y.radialGradient
              ? (g = "radialGradient")
              : y.linearGradient && (g = "linearGradient");
            g &&
              ((l = y[g]),
              (S = r.gradients),
              (L = y.stops),
      ...
      applyTextOutline: function(y) {
        ...
        -1 !== y.indexOf("contrast") &&
          (y = y.replace(/contrast/g, this.renderer.getContrast(f.style.fill)));
        y = y.split(" ");
        b = y[y.length - 1];
        (c = y[0]) &&
          "none" !== c &&
          a.svg &&
          ((this.fakeTS = !0),
          (y = [].slice.call(f.getElementsByTagName("tspan"))),
          (this.ySetter = this.xSetter),
          (c = c.replace(/(^[\d\.]+)(.*?)$/g, function(a, y, f) {
            return 2 * y + f;
          })),
          this.removeTextOutline(y),
          (r = f.firstChild),
          y.forEach(function(a, y) {
            0 === y &&
      ...
      removeTextOutline: function(a) {
        for (var y = a.length, f; y--; )
          (f = a[y]),
            "highcharts-text-outline" === f.getAttribute("class") &&
              g(a, this.element.removeChild(f));
      },
      ...
      attr: function(y, f, b, c) {
        ...
        "string" === typeof y &&
          ...
          ((r = y), (y = {}), (y[r] = f));
        "string" === typeof y
          ? (l = (this[y + "Getter"] || this._defaultGetter).call(this, y, d))
          : (B(
              y,
              function(f, b) {
                n = !1;
                ...
                this.symbolName &&
                  -1 !== a.inArray(b, m) &&
                  (g || (this.symbolAttr(y), (g = !0)), (n = !0));
                !this.rotation ||
                  ("x" !== b && "y" !== b) ||
                  (this.doTransform = !0);
                n ||
                  ((h = this[b + "Setter"] || this._defaultSetter),
                  h.call(this, f, b, d),
                  !this.styledMode &&
                    this.shadows &&
        ...
        l &&
          ...
          a &&
            (null === a.width || "auto" === a.width
              ...
              : "text" === c.nodeName.toLowerCase() &&
                a.width &&
                (r = this.textWidth = H(a.width))),
          (this.styles = a),
          r && !M && this.renderer.forExport && delete a.width,
          c.namespaceURI === this.SVG_NS
            ? ((g = function(a, y) {
                return "-" + y.toLowerCase();
              }),
              B(a, function(a, y) {
                -1 === n.indexOf(y) &&
                  (d += y.replace(/([A-Z])/g, g) + ":" + a + ";");
              }),
              d && e(c, "style", d))
            : u(c, a),
          this.added &&
      ...
      strokeWidth: function() {
        ...
        a.indexOf("px") === a.length - 2
          ? (a = H(a))
          : ((f = m.createElementNS(L, "rect")),
            e(f, { width: a, "stroke-width": 0 }),
          ...
          : d &&
            a.push(
              "rotate(" +
                d +
                " " +
                E(this.rotationOriginX, l.getAttribute("x"), 0) +
                " " +
                E(this.rotationOriginY, l.getAttribute("y") || 0) +
                ")"
            );
      ...
      align: function(a, f, b) {
        ...
        if (a) {
          if (
            ((this.alignOptions = a), (this.alignByTranslate = f), !b || D(b))
          )
            (this.alignTo = y = b || "renderer"),
              g(r, this),
              r.push(this),
              (b = null);
        } else
      ...
      getBBox: function(a, f) {
        ...
        r = f * h;
        g = c.styledMode
          ? d && C.prototype.getStyle.call(d, "font-size")
          : l && l.fontSize;
        p(n) &&
          ((B = n.toString()),
          -1 === B.indexOf("\x3c") && (B = B.replace(/[0-9]/g, "0")),
          (B += ["", f || 0, g, this.textWidth, l && l.textOverflow].join()));
        B && !a && (y = L[B]);
        if (!y) {
          if (x || c.forExport) {
            try {
              (m =
                ...
                function(a) {
                  [].forEach.call(
                    d.querySelectorAll(".highcharts-text-outline"),
                    function(y) {
                      y.style.display = a;
                    }
                  );
          ...
          c.isSVG &&
            ...
            f &&
              ((y.width =
                Math.abs(c * Math.sin(r)) + Math.abs(a * Math.cos(r))),
              (y.height =
                Math.abs(c * Math.cos(r)) + Math.abs(a * Math.sin(r)))));
          if (B && 0 < y.height) {
        ...
        if (!a) this.destroyShadows();
          ...
          for (c = 1; c <= g; c++)
            (r = d.cloneNode(0)),
              ...
              b &&
                (e(r, "height", Math.max(e(r, "height") - l, 0)),
                (r.cutHeight = l)),
              f
                ? f.element.appendChild(r)
                : d.parentNode && d.parentNode.insertBefore(r, d),
              y.push(r);
          this.shadows = y;
        }
        return this;
      ...
      titleSetter: function(a) {
        ...
        f ||
          ((f = m.createElementNS(this.SVG_NS, "title")),
      ...
      setTextPath: function(f, b) {
        ...
        if (f && b && b.enabled) {
          this.options &&
            ...
            (r.dx = -this.options.padding);
          g ||
            ((this.textPathWrapper = g = this.renderer.createElement(
              "textPath"
            )),
            (d = !0));
          l = g.element;
          (b = f.element.getAttribute("id")) ||
            f.element.setAttribute("id", (b = a.uniqueKey()));
          if (h)
          ...
          this.removeTextOutline.call(
            g,
            [].slice.call(y.getElementsByTagName("tspan"))
          );
      ...
      fillSetter: function(a, f, b) {
        "string" === typeof a
          ? b.setAttribute(f, a)
          : a && this.complexColor(a, f, b);
      },
      visibilitySetter: function(a, f, b) {
        "inherit" === a
          ? b.removeAttribute(f)
          : this[f] !== a && b.setAttribute(f, a);
        this[f] = a;
      },
      zIndexSetter: function(a, f) {
        ...
        p(a)
          ? (d.setAttribute("data-z-index", a),
            (a = +a),
            this[f] === a && (r = !1))
          : p(this[f]) && d.removeAttribute("data-z-index");
        this[f] = a;
        if (r) {
    ...
    C.prototype["stroke-widthSetter"] = C.prototype.strokeSetter = function(
      ...
      this.stroke && this["stroke-width"]
        ? (C.prototype.fillSetter.call(this, this.stroke, "stroke", b),
    ...
    b(I.prototype, {
      ...
      init: function(a, f, b, c, r, d, l) {
        ...
        this.alignedObjects = [];
        this.url =
          (w || A) && m.getElementsByTagName("base").length
            ? O.location.href
                .split("#")[0]
                .replace(/<[^>]*>/g, "")
                .replace(/([\('\)])/g, "\\$1")
        ...
        this.createElement("desc")
          .add()
          .element.appendChild(
            m.createTextNode("Created with Highcharts 7.1.1")
          );
        ...
        w &&
          ...
          f(),
          (this.unSubPixelFix = F(O, "resize", f)));
      },
      definition: function(a) {
        function f(a, c) {
          ...
          r(a).forEach(function(a) {
            ...
            r.add(c || b.defs);
            a.textContent &&
              r.element.appendChild(m.createTextNode(a.textContent));
            f(a.children || [], r);
            y = r;
          });
          return y;
          ...
          p = function(d, g) {
            ...
            if (void 0 === x[g])
              if (f.getSubStringLength)
                ...
                y.getSpanWidth &&
                  (B(l(b || c, d)), (x[g] = r + y.getSpanWidth(a, f)));
            return x[g];
          },
          e,
          z;
          ...
          k = function(a) {
            ...
            b.styledMode ||
              (c = /(px|em)$/.test(a && a.style.fontSize)
                ? a.style.fontSize
                : N || b.style.fontSize || 12);
            return w
              ? H(w)
              : b.fontMetrics(c, a.getAttribute("style") ? a : f).h;
          },
          J = function(a, f) {
            B(b.escapes, function(b, c) {
              (f && -1 !== f.indexOf(b)) ||
                (a = a.toString().replace(new RegExp(b, "g"), c));
            });
            return a;
          },
          O = function(a, f) {
        ...
        if (P !== a.textCache) {
          ...
          y || x || p || h || -1 !== r.indexOf(" ")
            ? (n && n.appendChild(f),
              ...
              r.forEach(function(r, y) {
                ...
                d.forEach(function(r) {
                  if ("" !== r || 1 === d.length) {
                    ...
                    (E = O(r, "href")) &&
                      !c &&
                      (e(B, "onclick", 'location.href\x3d"' + E + '"'),
                      e(B, "class", "highcharts-anchor"),
                      b.styledMode || u(B, { cursor: "pointer" }));
              ...
              p && g && a.attr("title", J(a.textStr, ["\x26lt;", "\x26gt;"])),
              n && n.removeChild(f),
              x && a.applyTextOutline && a.applyTextOutline(x))
            : f.appendChild(m.createTextNode(J(r)));
        }
      },
      ...
      arc: function(a, f, b, r, c, d) {
        J(a)
          ? ((r = a), (f = r.y), (b = r.r), (a = r.x))
          : (r = { innerR: r, start: c, end: d });
      ...
      rect: function(a, f, b, r, c, d) {
        ...
        a = J(a)
          ...
          : void 0 === a
          ? {}
          : { x: a, y: f, width: Math.max(b, 0), height: Math.max(r, 0) };
        this.styledMode ||
          (void 0 !== d && ((a.strokeWidth = d), (a = g.crisp(a))),
          (a.fill = "none"));
        c && (a.r = c);
      ...
      symbol: function(a, f, r, c, d, g) {
        var l = this,
          ...
          B =
            p(f) &&
            w &&
            w.call(this.symbols, Math.round(f), Math.round(r), c, d, g),
          x,
          e;
        w
          ? ((n = this.path(B)),
            l.styledMode || n.attr("fill", "none"),
            b(n, { symbolName: L, x: f, y: r, width: c, height: d }),
            g && b(n, g))
          : h &&
            ((x = a.match(y)[1]),
            (n = this.image(x)),
            (n.imgwidth = E(P[x] && P[x].width, g && g.width)),
            (n.imgheight = E(P[x] && P[x].height, g && g.height)),
            (e = function() {
            ...
            ["width", "height"].forEach(function(a) {
              n[a + "Setter"] = function(a, f) {
                ...
                p(r) &&
                  ...
                  this.element && this.element.setAttribute(f, r),
                  this.alignByTranslate ||
                    ((b[c] = ((this[f] || 0) - r) / 2), this.attr(b)));
              };
            }),
            p(f) && n.attr({ x: f, y: r }),
            (n.isImg = !0),
            p(n.imgwidth) && p(n.imgheight)
              ? e()
      ...
      symbols: {
        ...
        arc: function(a, f, b, r, c) {
          var d = c.start,
            ...
            n = c.end - 0.001;
          b = c.innerR;
          r = E(c.open, 0.001 > Math.abs(c.end - c.start - 2 * Math.PI));
          var y = Math.cos(d),
            h = Math.sin(d),
            L = Math.cos(n),
            n = Math.sin(n),
            d = 0.001 > c.end - d - Math.PI ? 0 : 1;
          c = [
            "M",
            a + g * y,
            f + l * h,
        ...
        callout: function(a, f, b, r, c) {
          ...
          l && l > b
            ...
            : l && 0 > l
            ? c > f + g && c < f + r - g
              ? n.splice(33, 3, "L", a, c + 6, a - 6, c, a, c - 6, a, f + d)
              : n.splice(33, 3, "L", a, r / 2, l, c, a, r / 2, a, f + d)
            : c && c > r && l > a + g && l < a + b - g
            ? n.splice(
                23,
                3,
            ...
            : c &&
              ...
              l > a + g &&
              l < a + b - g &&
              n.splice(3, 3, "L", l - 6, f, l, f - 6, l + 6, f, b - d, f);
          return n;
        }
      },
      ...
      fontMetrics: function(a, f) {
        a =
          (!this.styledMode && /px/.test(a)) || !O.getComputedStyle
            ? a ||
              (f && f.style && f.style.fontSize) ||
              (this.style && this.style.fontSize)
            : f && C.prototype.getStyle.call(f, "font-size");
        a = /px/.test(a) ? H(a) : 12;
        f = 24 > a ? a + 3 : Math.round(1.2 * a);
        return { h: f, b: Math.round(0.8 * f), f: a };
      },
      ...
      label: function(r, c, d, g, l, h, L, w, m) {
        ...
        U = function() {
          var a = e.element.style,
            f = {};
          M =
            (void 0 === A || void 0 === D || J) && p(e.textStr) && e.getBBox();
          x.width = (A || M.width || 0) + 2 * N + E;
          x.height = (D || M.height || 0) + 2 * N;
          t =
            N +
            Math.min(
              y.fontMetrics(a && a.fontSize, e).b,
              M ? M.height : Infinity
            );
          u &&
            (z ||
              ((x.box = z = y.symbols[g] || q ? y.symbol(g) : y.rect()),
              z.addClass(
              ...
              (f.x = a),
              (f.y = (w ? -t : 0) + a)),
            (f.width = Math.round(x.width)),
            (f.height = Math.round(x.height)),
            z.attr(b(f, O)),
            (O = {}));
        };
        R = function() {
          ...
          p(A) &&
            M &&
            ("center" === J || "right" === J) &&
            (a += { center: 0.5, right: 1 }[J] * (A - M.width));
          if (a !== e.x || f !== e.y)
            e.attr("x", a),
              e.hasBoxWidthChanged && ((M = e.getBBox(!0)), U()),
              void 0 !== f && e.attr("y", f);
          e.x = a;
          e.y = f;
        };
        ...
        x.xSetter = function(a) {
          x.x = a;
          P &&
            ((a -= P * ((A || M.width) + 2 * N)), (x["forceAnimate:x"] = !0));
          H = Math.round(a);
          x.attr("translateX", H);
        };
  ...
  K(G, "parts/Html.js", [G["parts/Globals.js"]], function(a) {
    ...
    e(h.prototype, {
        ...
        if (this.added) {
          ...
          if ("SPAN" === d.tagName) {
            var A = this.rotation,
              ...
              E;
            (E = x !== this.oldTextWidth) &&
              !(E = x > this.oldTextWidth) &&
              ((E = this.textPxLength) ||
                (F(d, { width: "", whiteSpace: n || "nowrap" }),
                (E = d.offsetWidth)),
              (E = E > x));
            E &&
            ...
            B !== this.cTT &&
              ((n = a.fontMetrics(d.style.fontSize, d).b),
              !k(A) ||
                (A === (this.oldRotation || 0) && e === this.oldAlign) ||
                this.setSpanRotation(A, D, n),
              this.getSpanCorrection(
                (!k(A) && this.textPxLength) || d.offsetWidth,
                n,
                D,
                A,
                e
      ...
      setSpanRotation: function(a, d, l) {
        ...
        b[g + (q ? "Origin" : "-origin")] = b.transformOrigin =
          100 * d + "% " + l + "px";
        F(this.element, b);
      },
    ...
    e(d.prototype, {
      ...
      html: function(b, d, l) {
        ...
        c.attr({ text: b, x: Math.round(d), y: Math.round(l) }).css({
          position: "absolute"
        });
        A ||
          c.css({
          ...
          ? ((this.get = function(a, h) {
            ...
            (this.set = function(a, h, d) {
              ...
              if (
                "Milliseconds" === a ||
                "Seconds" === a ||
                ("Minutes" === a && 0 === h.getTimezoneOffset() % 60)
              )
                h["set" + a](d);
              else
                (m = v.getTimezoneOffset(h)),
                  (m = h.getTime() - m),
                  h.setTime(m),
                  h["setUTC" + a](d),
                  (a = v.getTimezoneOffset(h)),
                  (m = h.getTime() + a),
                  h.setTime(m);
            }))
          : e
      ...
      makeTime: function(e, q, v, p, h, d) {
        ...
        this.useUTC
          ? ((m = this.Date.UTC.apply(0, arguments)),
            (b = this.getTimezoneOffset(m)),
            (m += b),
            (g = this.getTimezoneOffset(m)),
            b !== g
              ? (m += g - b)
              : b - 36e5 !== this.getTimezoneOffset(m - 36e5) ||
                a.isSafari ||
                (m -= 36e5))
          : (m = new this.Date(
              e,
      ...
      getTimeTicks: function(a, q, v, p) {
        ...
        if (C(q)) {
          h.set(
            "Milliseconds",
            m,
            l >= e.second ? 0 : c * Math.floor(h.get("Milliseconds", m) / c)
          );
          l >= e.second &&
            h.set(
              "Seconds",
              m,
              l >= e.minute ? 0 : c * Math.floor(h.get("Seconds", m) / c)
            );
          l >= e.minute &&
            h.set(
              "Minutes",
              m,
              l >= e.hour ? 0 : c * Math.floor(h.get("Minutes", m) / c)
            );
          l >= e.hour &&
            h.set(
              "Hours",
              m,
              l >= e.day ? 0 : c * Math.floor(h.get("Hours", m) / c)
            );
          l >= e.day &&
            h.set(
              "Date",
              ...
              l >= e.month
                ? 1
                : Math.max(1, c * Math.floor(h.get("Date", m) / c))
            );
          l >= e.month &&
            (h.set(
              "Month",
              m,
              l >= e.year ? 0 : c * Math.floor(h.get("Month", m) / c)
            ),
            (g = h.get("FullYear", m)));
          l >= e.year && h.set("FullYear", m, g - (g % c));
          l === e.week &&
            ((g = h.get("Day", m)),
            h.set("Date", m, h.get("Date", m) - g + p + (g < p ? -7 : 0)));
          g = h.get("FullYear", m);
          p = h.get("Month", m);
          var z = h.get("Date", m),
            J = h.get("Hours", m);
          ...
          h.variableTimezone &&
            (w =
              v - q > 4 * e.month ||
              h.getTimezoneOffset(q) !== h.getTimezoneOffset(v));
          q = m.getTime();
          for (m = 1; q < v; )
            d.push(q),
              (q =
                l === e.year
                  ...
                  : !w || (l !== e.day && l !== e.week)
                  ? w && l === e.hour && 1 < c
                    ? h.makeTime(g, p, z, J + m * c)
                    : q + l * c
                  : h.makeTime(g, p, z + m * c * (l === e.day ? 1 : 7))),
              m++;
          d.push(q);
          l <= e.hour &&
            1e4 > d.length &&
        ...
        d.info = I(a, { higherRanks: b, totalRange: l * c });
        return d;
      }
    };
  });
  ...
  K(G, "parts/Tick.js", [G["parts/Globals.js"]], function(a) {
    ...
    a.Tick.prototype = {
      addLabel: function() {
        ...
        p.isDatetimeAxis &&
          c &&
          ((A = d.time.resolveDTLFormat(
            h.dateTimeLabelFormats[(!h.grid && c.higherRanks[g]) || c.unitName]
          )),
          (D = A.main));
        e.isFirst = w;
        e.isLast = z;
              ...
              if (
                (k.attr({
                  text: p.labelFormatter.call(
                    a.extend(e.formatCtx, { dateTimeLabelFormat: x[n] })
                  )
                }),
                k.getBBox().width < p.getSlotWidth(e) - 2 * t(l.padding, 5))
              )
                return;
            k.attr({ text: "" });
          };
        if (I(k))
          ...
          if (
            (e.label = k =
              I(h) && l.enabled
                ? d.renderer.text(h, 0, 0, l.useHTML).add(p.labelGroup)
                : null)
          )
            d.styledMode || k.css(q(l.style)),
      ...
      handleOverflow: function(a) {
        var e = this.axis,
          ...
          b = t(
            e.labelRight,
            Math.max(e.isRadial ? 0 : e.pos + e.len, m - b[1])
          ),
          l = this.label,
          c = this.rotation,
        ...
        if (c || "justify" !== t(h.overflow, "justify"))
          0 > c && d - w * z < g
            ? (n = Math.round(d / Math.cos(c * u) - g))
            : 0 < c &&
              d + w * z > b &&
              (n = Math.round((m - d) / Math.cos(c * u)));
        else if (
          ((m = d + (1 - w) * z),
          d - w * z < g
            ? (D = a.x + D * (1 - w) - g)
          ...
          D < k &&
            "center" === e.labelAlign &&
            (a.x += A * (k - D - w * (k - Math.min(z, D)))),
          z > D || (e.autoRotation && (l.styles || {}).width))
        )
          n = D;
        n &&
          (this.shortenLabel
            ? this.shortenLabel()
            : ((x.width = Math.floor(n)),
              (h.style || {}).textOverflow || (x.textOverflow = "ellipsis"),
              l.css(x)));
      },
      getPosition: function(e, p, h, d) {
        ...
        e = {
          x: e
            ? a.correctFloat(m.translate(p + h, null, null, d) + m.transB)
            : m.left +
              m.offset +
              (m.opposite
                ? ((d && b.oldChartWidth) || b.chartWidth) - m.right - m.left
                : 0),
          y: e
            ? g - m.bottom + m.offset - (m.opposite ? m.height : 0)
            : a.correctFloat(g - m.translate(p + h, null, null, d) - m.transB)
        };
        k(this, "afterGetPosition", { pos: e });
        return e;
      },
      getLabelPosition: function(a, e, h, d, m, b, g, l) {
        var c = this.axis,
          w = c.transA,
          z = c.reversed,
          p = c.staggerLines,
        ...
        I(A) ||
          (A =
            0 === c.side
              ...
              : 2 === c.side
              ? D.y + 8
              : Math.cos(h.rotation * u) * (D.y - h.getBBox(!1, 0).height / 2));
      ...
      renderGridLine: function(a, e, h) {
        ...
        b ||
          (d.chart.styledMode ||
            ((g.stroke = A), (g["stroke-width"] = k), m && (g.dashstyle = m)),
          c || (g.zIndex = 1),
          a && (e = 0),
          (this.gridLine = b = z
            .path()
            .attr(g)
            .addClass("highcharts-" + (c ? c + "-" : "") + "grid-line")
            .add(d.gridGroup)));
        ...
        c &&
          ...
          z &&
            ((this.mark = w = b
              ...
              .add(d.axisGroup)),
            d.chart.styledMode || w.attr({ stroke: m, "stroke-width": k })),
          w[z ? "attr" : "animate"]({
      ...
      renderLabel: function(a, p, h, d) {
        ...
        l &&
          e(k) &&
          ((l.xy = a = this.getLabelPosition(k, a, l, b, c, m, d, w)),
          (this.isFirst && !this.isLast && !t(g.showFirstLabel, 1)) ||
          (this.isLast && !this.isFirst && !t(g.showLastLabel, 1))
            ? (z = !1)
            : !b ||
              c.step ||
              c.rotation ||
  ...
  K(G, "parts/Axis.js", [G["parts/Globals.js"]], function(a) {
    ...
    a.extend(H.prototype, {
      ...
      init: function(a, b) {
        ...
        r.side =
          b.side || (r.horiz ? (r.opposite ? 0 : 2) : r.opposite ? 1 : 3);
        r.setOptions(b);
        var c = this.options,
          l = c.type;
        ...
        r.crosshair = D(
          c.crosshair,
          x(a.options.tooltip.crosshairs)[f ? 0 : 1],
          !1
        );
        b = r.options.events;
        -1 === a.axes.indexOf(r) &&
          (f ? a.axes.splice(a.xAxis.length, 0, r) : a.axes.push(r),
          a[r.coll].push(r));
        r.series = r.series || [];
        a.inverted &&
          !r.isZAxis &&
            ...
            if (f.visible || !b.options.chart.ignoreHiddenSeries) {
              ...
              if (a.isXAxis)
                (r = f.xData),
                  r.length &&
                    ...
                    r.length &&
                      ...
                      (a.dataMax = Math.max(D(a.dataMax, n), n))));
              else if (
                (f.getExtremes(),
                (n = f.dataMax),
                (g = f.dataMin),
                u(g) &&
                  ...
                  (a.dataMax = Math.max(D(a.dataMax, n), n))),
                u(d) && (a.threshold = d),
                !r.softThreshold || a.positiveValuesOnly)
              )
                a.softThreshold = !1;
            }
          });
      ...
      translate: function(a, b, c, d, g, n) {
        ...
        b
          ? ((a = (a * r + e - x) / h + d), g && (a = f.lin2val(a)))
          : (g && (a = f.val2lin(a)),
            (a = l(d)
              ? r * (a - d) * h + e + r * x + (l(n) ? h * n : 0)
              : void 0));
        return a;
      },
      ...
      getPlotLinePath: function(a, b, c, g, n) {
        var f = this,
          r = f.chart,
          e = f.left,
          h = f.top,
          ...
          E = function(a, f, b) {
            if (("pass" !== g && a < f) || a > b)
              g ? (a = Math.min(Math.max(f, a), b)) : (p = !0);
            return a;
          };
        ...
        d(this, "getPlotLinePath", A, function(d) {
          ...
          l(n)
            ? f.horiz
              ? ((m = h), (w = L - f.bottom), (x = B = E(x, e, e + f.width)))
              : ((x = e), (B = z - f.right), (m = w = E(m, h, h + f.height)))
            : ((p = !0), (g = !1));
          d.path =
            p && !g
              ? null
              : r.renderer.crispLine(["M", x, m, "L", B, w], b || 1);
        });
        return A.path;
      },
      ...
      getMinorTickPositions: function() {
        ...
        if (e && e / d < a.len / 3)
          if (a.isLog)
            this.paddedTicks.forEach(function(f, b, r) {
              b &&
                g.push.apply(g, a.getLogTickPositions(d, r[b - 1], r[b], !0));
            });
      ...
      adjustForMinRange: function() {
        ...
        c - b < this.minRange &&
          ((g = this.dataMax - this.dataMin >= this.minRange),
          (m = this.minRange),
          (d = (m - c + b) / 2),
          (d = [b - d, D(a.min, b - d)]),
          g && (d[2] = this.isLog ? this.log2lin(this.dataMin) : this.dataMin),
          (b = F(d)),
          (c = [b + m, D(a.max, b + m)]),
          g && (c[2] = this.isLog ? this.log2lin(this.dataMax) : this.dataMax),
          (c = k(c)),
          c - b < m && ((d[0] = c - m), (d[1] = D(a.min, c - m)), (b = F(d))));
        this.min = b;
        this.max = c;
      },
      getClosest: function() {
          ...
          (this.series || []).forEach(function(f) {
            ...
            f.data.forEach(function(b, c) {
              ...
              b &&
                ...
                void 0 !== b.name &&
                ((r = a.nameToX(b)),
                void 0 !== r && r !== b.x && ((b.x = r), (f.xData[c] = r)));
            });
          }));
      },
      setAxisTranslation: function(a) {
        ...
        if (w || m || g)
          (l = f.getClosest()),
            x
              ? ((e = x.minPointOffset), (h = x.pointRangePadding))
              : f.series.forEach(function(a) {
                  var b = m
                      ? 1
                      : w
                      ? D(a.options.pointRange, l, 0)
                      : f.axisPointRange || 0,
                    r = a.options.pointPlacement;
                  g = Math.max(g, b);
                  if (!f.single || m)
                    (a = n.xrange && a instanceof n.xrange ? !w : w),
                      (e = Math.max(e, a && c(r) ? 0 : b / 2)),
                      (h = Math.max(h, a && "on" === r ? 0 : b));
                }),
            (x = f.ordinalSlope && l ? f.ordinalSlope / l : 1),
            (f.minPointOffset = e *= x),
            (f.pointRangePadding = h *= x),
            (f.pointRange = Math.min(g, b)),
            w && (f.closestPointRange = l);
        a && (f.oldTransA = B);
        f.translationSlope = f.transA = B =
          f.staticScale || f.len / (b + h || 1);
      ...
      setTickInterval: function(f) {
        ...
        C = D(c.userMax, n.max);
        m
          ? ((c.linkedParent = g[c.coll][n.linkedTo]),
            (p = c.linkedParent.getExtremes()),
            (c.min = D(p.min, p.dataMin)),
            (c.max = D(p.max, p.dataMax)),
            n.type !== c.linkedParent.options.type && a.error(11, 1, g))
          : (!J &&
              u(H) &&
              (c.dataMin >= H
                ? ((p = H), (w = 0))
                : c.dataMax <= H && ((t = H), (B = 0))),
            (c.min = D(v, p, c.dataMin)),
            (c.max = D(C, t, c.dataMax)));
        e &&
          (c.positiveValuesOnly &&
            !f &&
            0 >= Math.min(c.min, D(c.dataMin, c.min)) &&
            a.error(10, 1, g),
          (c.min = q(c.log2lin(c.min), 15)),
          (c.max = q(c.log2lin(c.max), 15)));
        c.range &&
          u(c.max) &&
        ...
        c.adjustForMinRange();
        !(E || c.axisPointRange || c.usePercentage || m) &&
          u(c.min) &&
          u(c.max) &&
          (g = c.max - c.min) &&
          (!u(v) && w && (c.min -= g * w), !u(C) && B && (c.max += g * B));
        l(n.softMin) &&
          !l(c.userMin) &&
          n.softMin < c.min &&
          (c.min = v = n.softMin);
        l(n.softMax) &&
          ...
          (c.max = C = n.softMax);
        l(n.floor) &&
          (c.min = Math.min(Math.max(c.min, n.floor), Number.MAX_VALUE));
        l(n.ceiling) &&
          (c.max = Math.max(
            Math.min(c.max, n.ceiling),
            D(c.userMax, -Number.MAX_VALUE)
          ));
        J &&
          u(c.dataMin) &&
          ((H = H || 0),
          !u(v) && c.min < H && c.dataMin >= H
            ? (c.min = c.options.minRange ? Math.min(H, c.max - c.minRange) : H)
            : !u(C) &&
              c.max > H &&
              c.dataMax <= H &&
              (c.max = c.options.minRange
                ? Math.max(H, c.min + c.minRange)
                : H));
        c.tickInterval =
          c.min === c.max || void 0 === c.min || void 0 === c.max
            ? 1
            : m && !k && A === c.linkedParent.options.tickPixelInterval
            ? (k = c.linkedParent.tickInterval)
            : D(
                k,
                this.tickAmount
                  ? (c.max - c.min) / Math.max(this.tickAmount - 1, 1)
                  : void 0,
                E ? 1 : ((c.max - c.min) * A) / Math.max(c.len, A)
              );
        x &&
          !f &&
      ...
      setTickPositions: function() {
        ...
        !c &&
          ...
          (this.max - this.min) / this.tickInterval >
            ...
            ? ((c = [this.min, this.max]), a.error(19, !1, this.chart))
      ...
      zoom: function(a, c) {
        ...
        d(this, "zoom", a, function(a) {
          var c = a.newMin,
            d = a.newMax;
          if (c !== this.min || d !== this.max)
            this.allowZoomOutside ||
              (u(f) && (c < l && (c = l), c > n && (c = n)),
              u(b) && (d < l && (d = l), d > n && (d = n))),
              (this.displayBtn = void 0 !== c || void 0 !== d),
              this.setExtremes(c, d, !1, void 0, { trigger: "zoom" });
          a.zoomed = !0;
        });
        return a.zoomed;
      },
      setAxisSize: function() {
        var f = this.chart,
          ...
          g = (this.width = Math.round(
            a.relativeLength(D(c.width, f.plotWidth - b[3] + b[1]), f.plotWidth)
          )),
          l = (this.height = Math.round(
            a.relativeLength(
              D(c.height, f.plotHeight - b[0] + b[2]),
              f.plotHeight
            )
          )),
          n = (this.top = Math.round(
            a.relativeLength(
              D(c.top, f.plotTop + b[0]),
              f.plotHeight,
              f.plotTop
            )
          )),
      ...
      unsquish: function() {
        ...
        c
          ? (m =
              ...
              (u(n)
                ? [n]
                : g < D(a.autoRotationLimit, 80) && a.autoRotation)) &&
            m.forEach(function(a) {
              var f;
              if (a === n || (a && -90 <= a && 90 >= a))
                (h = w(Math.abs(e.h / Math.sin(v * a)))),
                  (f = h + Math.abs(a / 360)),
                  f < x && ((x = f), (l = a), (d = h));
            })
          : a.step || (d = w(e.h));
      ...
      getSlotWidth: function(a) {
        ...
        return (
          ...
          (!c &&
            ((b.style && parseInt(b.style.width, 10)) ||
              (g && g - f.spacing[3]) ||
              0.33 * f.chartWidth))
        );
      },
      renderUnsquish: function() {
        ...
        d.forEach(function(a) {
          (a = g[a]) &&
            a.label &&
            a.label.textPxLength > k &&
            (k = a.label.textPxLength);
        });
        this.maxLabelLength = k;
        if (this.autoRotation)
          k > x && k > B.h
            ? (m.rotation = this.labelRotation)
          ...
          for (p = "clip", x = d.length; !e && x--; )
            if (((A = d[x]), (A = g[A].label)))
              A.styles && "ellipsis" === A.styles.textOverflow
                ...
                : A.textPxLength > h && A.css({ width: h + "px" }),
                A.getBBox().height > this.len / d.length - (B.h - B.f) &&
                  (A.specificTextOverflow = "ellipsis");
        m.rotation &&
          ((z = k > 0.5 * a.chartHeight ? 0.33 * a.chartHeight : k),
          w || (p = "ellipsis"));
        if (
          (this.labelAlign = l.align || this.autoLabelAlign(this.labelRotation))
        )
          ...
          f &&
            ...
            a.shortenLabel
              ...
              : z &&
                !c &&
                "nowrap" !== n.whiteSpace &&
                (z < f.textPxLength || "SPAN" === f.element.tagName)
              ? ((b.width = z),
                w || (b.textOverflow = f.specificTextOverflow || p),
                f.css(b))
              : f.styles &&
                f.styles.width &&
                !b.width &&
      ...
      addTitle: function(a) {
        ...
        this.axisTitle ||
          ...
          (this.axisTitle = f
            ...
            .attr({ zIndex: 7, rotation: d.rotation || 0, align: g })
            .addClass("highcharts-axis-title")),
          l || this.axisTitle.css(w(d.style)),
      ...
      getOffset: function() {
        ...
        m || a.isLinked
          ? (l.forEach(function(c, b) {
            ...
            a.staggerLines && (E *= a.staggerLines),
        ...
        k &&
          ...
          B &&
            !1 !== k.reserveSpace &&
            ((a.titleOffset = w = a.axisTitle.getBBox()[
              e ? "height" : "width"
            ]),
            (z = k.offset),
            (p = u(z) ? 0 : D(k.margin, e ? 5 : 10))));
        a.renderLine();
        ...
        a.getMaxLabelDimensions &&
          (a.maxLabelDimensions = a.getMaxLabelDimensions(n, l));
        e = this.tickSize("tick");
        H[h] = Math.max(
          H[h],
          a.axisTitleMargin + w + q * a.offset,
          p,
          l && l.length && e ? e[0] + q * a.offset : 0
        );
      ...
      getLinePath: function(a) {
        ...
        return c.renderer.crispLine(
          [
            ...
            d ? f : this.top,
            "L",
            d ? c.chartWidth - this.right : g,
            d ? f : c.chartHeight - this.bottom
          ],
          a
        );
      },
      ...
      renderTick: function(a, c) {
        ...
        if (!b || (a >= this.min && a <= this.max))
          f[a] || (f[a] = new E(this, a)),
            d && f[a].isNew && f[a].render(c, !0, -1),
            f[a].render(c);
      },
      render: function() {
        var c = this,
        ...
        if (c.hasData() || e)
          c.minorTickInterval &&
            ...
            h.length &&
              ...
              A &&
                (0 === c.min || c.single) &&
                (m[-1] || (m[-1] = new E(c, -1, null, !0)), m[-1].render(-1))),
            k &&
              h.forEach(function(f, d) {
                ...
                0 === d % 2 &&
                  f < c.max &&
                  v <= c.max + (b.polar ? -A : A) &&
                  (z[f] || (z[f] = new a.PlotLineOrBand(c)),
                  (t = f + A),
                  (z[f].options = {
        ...
        if (this.crosshair && !1 !== (u(c) || !g)) {
          ...
          u(l) &&
            (b =
              this.getPlotLinePath(
                c && (this.isXAxis ? c.x : D(c.stackY, c.y)),
                null,
                null,
                null,
                l
          ...
          n ||
            ...
            this.chart.styledMode ||
              ...
              f.dashStyle && n.attr({ dashstyle: f.dashStyle })));
          n.show().attr({ d: b });
  ...
  K(G, "parts/DateTimeAxis.js", [G["parts/Globals.js"]], function(a) {
    ...
    C.prototype.normalizeTimeTickInterval = function(a, q) {
      ...
      for (
        ...
        (u = k[q[0]]),
        (v = q[1]),
        e[p + 1] && a <= (u * v[v.length - 1] + k[e[p + 1][0]]) / 2);
        p++
      );
      ...
      if (0.5 <= a)
        ...
        for (
          ...
          for (m = e.length, d = 0; d < m && !l; d++)
            (b = this.log2lin(this.lin2log(p) * e[d])),
              b > q && (!u || g <= t) && void 0 !== g && h.push(g),
              g > t && (l = !0),
              (g = b);
      else
        (q = this.lin2log(q)),
          (t = this.lin2log(t)),
          (a = u ? this.getMinorTickInterval() : e.tickInterval),
          (a = k(
            "auto" === a ? null : a,
            this._minorAutoInterval,
            ((e.tickPixelInterval / (u ? 5 : 1)) * (t - q)) /
              ((u ? p / this.tickPositions.length : p) || 1)
          )),
          (a = F(a, null, I(a))),
          (h = this.getLinearTickPositions(a, q, t).map(this.log2lin)),
  ...
  K(
    ...
    [G["parts/Globals.js"], G["parts/Axis.js"]],
    function(a, C) {
      var I = a.arrayMax,
        F = a.arrayMin,
        k = a.defined,
      ...
      a.PlotLineOrBand.prototype = {
        render: function() {
          ...
          var e = this,
            ...
            f = w ? "bands" : "lines";
          p.isLog &&
            ((l = p.log2lin(l)), (g = p.log2lin(g)), (c = p.log2lin(c)));
          p.chart.styledMode ||
            (z
              ? ((A.stroke = n),
                (A["stroke-width"] = d.width),
                d.dashStyle && (A.dashstyle = d.dashStyle))
              : w &&
                (n && (A.fill = n),
                d.borderWidth &&
          ...
          E.zIndex = x;
          f += "-" + x;
          (n = p.plotLinesAndBandsGroups[f]) ||
            (p.plotLinesAndBandsGroups[f] = n = H.g("plot-" + f)
              .attr(E)
              .add());
          D &&
            (e.svgElem = q = H.path()
      ...
      a.extend(C.prototype, {
        getPlotBandPath: function(a, e) {
          ...
          if (d && h)
            for (
              a && ((l = d.toString() === h.toString()), (g = 0)), a = 0;
              a < d.length;
              a += 6
            )
              b && h[a + 1] === d[a + 1]
  ...
  K(G, "parts/Tooltip.js", [G["parts/Globals.js"]], function(a) {
    ...
    a.Tooltip.prototype = {
      ...
      getLabel: function() {
        ...
        this.label ||
          (this.outside &&
            ((this.container = b = a.doc.createElement("div")),
            ...
            (this.renderer = h = new a.Renderer(b, 0, 0))),
          this.split
          ...
          this.outside &&
            ((g = { x: this.label.xSetter, y: this.label.ySetter }),
      ...
      move: function(e, h, d, m) {
        var b = this,
          ...
          l =
            ...
            !b.isHidden &&
            (1 < Math.abs(e - g.x) || 1 < Math.abs(h - g.y)),
      ...
      getAnchor: function(a, e) {
        ...
        this.followPointer && e
          ? (void 0 === e.chartX && (e = h.normalize(e)),
            (a = [e.chartX - d.plotLeft, e.chartY - g]))
          : a[0].tooltipPos
          ? (a = a[0].tooltipPos)
      ...
      getPosition: function(a, e, d) {
        var h = this.chart,
          ...
          A = [
            ...
            k,
            e,
            (w ? p.top - b : 0) + d.plotY + h.plotTop,
            w ? 0 : h.plotTop,
            w ? k : h.plotTop + h.plotHeight
          ],
          n = [
            "x",
            z,
            a,
            (w ? p.left - b : 0) + d.plotX + h.plotLeft,
            w ? 0 : h.plotLeft,
            w ? z : h.plotLeft + h.plotWidth
          ],
          ...
          E = function(a, c, f, d) {
            ...
            d < b || d > c - b
              ? (l = !1)
              : (g[a] = d < f / 2 ? 1 : d > c - f / 2 ? c - f - 2 : d - f / 2);
            return l;
          },
          H = function(a) {
            var b = A;
      ...
      refresh: function(e, h) {
        ...
        m.enabled &&
          (a.clearTimeout(this.hideTimer),
          (this.followPointer = t(g)[0].series.tooltipOptions.followPointer),
          (l = this.getAnchor(g, h)),
          (h = l[0]),
          (b = l[1]),
          !c || (g.series && g.series.noSharedTooltip)
            ? (c = g.getLabelConfig())
            : ((p = d.pointer.getActiveSeries(g)),
              d.series.forEach(function(a) {
                (a.options.inactiveOtherPoints || -1 === p.indexOf(a)) &&
          ...
          (w = w.call(c, this)),
          (c = g.series),
          (this.distance = q(c.tooltipOptions.distance, 16)),
          !1 === w
            ? this.hide()
            : ((d = this.getLabel()),
              this.isHidden && d.attr({ opacity: 1 }).show(),
              this.split
                ? this.renderSplit(w, t(e))
                : ((m.style.width && !k) ||
                    d.css({ width: this.chart.spacingBox.width }),
                  d.attr({ text: w && w.join ? w.join("") : w }),
                  d
                    .removeClass(/highcharts-color-[\d]+/g)
                    .addClass(
                      "highcharts-color-" + q(g.colorIndex, c.colorIndex)
                    ),
                  k ||
                    d.attr({
      ...
      renderSplit: function(e, h) {
        ...
        e.slice(0, h.length + 1).forEach(function(a, n) {
          if (!1 !== a && "" !== a) {
            ...
            B ||
              ((B = { padding: c.padding, r: c.borderRadius }),
              b.styledMode ||
                ((B.fill = c.backgroundColor),
                (B.stroke = c.borderColor || n.color || A.color || "#333333"),
                (B["stroke-width"] = c.borderWidth)),
              (e.tt = B = g
                .label(
                  null,
                  null,
                  null,
                  (n.isHeader ? c.headerShape : c.shape) || "callout",
                  null,
                  null,
                  c.useHTML
                )
            ...
            n.isHeader
              ? ((w = a.height),
                b.xAxis[0].opposite && ((z = !0), (p -= w)),
                (A = Math.max(
                  0,
                  Math.min(
                    n.plotX + b.plotLeft - A / 2,
                    b.chartWidth +
                      (b.scrollablePixels
                        ? b.scrollablePixels - b.marginRight
                        : 0) -
                      A
                  )
                )))
              : (A = n.plotX + b.plotLeft - q(c.distance, 16) - A);
            0 > A && (l = !1);
            a =
              (n.series && n.series.yAxis && n.series.yAxis.pos) +
              (n.plotY || 0);
            a -= p;
        ...
        m.forEach(function(a) {
          ...
          a.tt.attr({
            ...
            x:
              l || g.isHeader || c.positioner
                ? a.x
                : g.plotX + b.plotLeft + d.distance,
            y: a.pos + p,
            anchorX: g.isHeader ? g.plotX + b.plotLeft : g.plotX + e.xAxis.pos,
            anchorY: g.isHeader
              ? b.plotTop + b.plotHeight / 2
              : g.plotY + e.yAxis.pos
          });
        });
      },
      updatePosition: function(a) {
        var e = this.chart,
          d = this.getLabel(),
          m = (this.options.positioner || this.getPosition).call(
            this,
            d.width,
            d.height,
            a
        ...
        var g;
        this.outside &&
          ((g = (this.options.borderWidth || 0) + 2 * this.distance),
          this.renderer.setSize(d.width + g, d.height + g, !1),
          (b += e.pointer.chartPosition.left - m.x),
          (a += e.pointer.chartPosition.top - m.y));
      ...
      getXDateFormat: function(a, e, d) {
        ...
        return (
          (h ? this.getDateFormat(h, a.x, d.options.startOfWeek, e) : e.day) ||
          e.year
        );
      },
      tooltipFooterHeaderFormatter: function(e, h) {
        ...
        a.fireEvent(this, "headerFormatter", h, function(a) {
          ...
          c &&
            g &&
            ((e.point && e.point.tooltipDateKeys) || ["key"]).forEach(function(
              a
            ) {
  ...
  K(G, "parts/Pointer.js", [G["parts/Globals.js"]], function(a) {
    ...
    a.Pointer.prototype = {
      ...
      getChartCoordinatesFromPoint: function(a, c) {
        ...
        if (d && b)
          return c
            ? { chartX: d.len + d.pos - g, chartY: b.len + b.pos - a.plotY }
      ...
      runPointActions: function(b, c) {
        var d = this.chart,
          ...
          h = this.getHoverData(
            ...
            d.series,
            "touchmove" !== b.type &&
              (!!c || (h && h.directTouch && this.isDirectTouch)),
            e,
            b
          ),
          n = [],
        ...
        if (l && (l !== d.hoverPoint || (g && g.isHidden))) {
          ...
          d.series.forEach(function(a) {
            (a.options.inactiveOtherPoints || -1 === n.indexOf(a)) &&
              a.setState("inactive", !0);
          });
          (x || []).forEach(function(a) {
            a.setState("hover");
          ...
          c &&
            ...
            !g.isHidden &&
            ((l = g.getAnchor([{}], b)),
            g.updatePosition({ plotX: l[0], plotY: l[1] }));
        this.unDocMouseMove ||
      ...
      scaleGroups: function(a, c) {
        ...
        b.series.forEach(function(g) {
          ...
          g.xAxis &&
            ...
            (g.group.attr(d),
            g.markerGroup &&
              (g.markerGroup.attr(d),
              g.markerGroup.clip(c ? b.clipRect : null)),
      ...
      drag: function(a) {
        ...
        (f && f.touch) ||
          ...
          (this.hasDragged = Math.sqrt(
            Math.pow(r - d, 2) + Math.pow(q - g, 2)
          )),
          10 < this.hasDragged &&
            ((p = c.isInsidePlot(r - n, q - h)),
            c.hasCartesianSeries &&
              (this.zoomX || this.zoomY) &&
              p &&
              !t &&
              !f &&
              ((this.selectionMarker = f = c.renderer
                .rect(n, h, e ? 1 : m, l ? 1 : E, 0)
            ...
            f &&
              e &&
              ((d -= r),
              f.attr({ width: Math.abs(d), x: (0 < d ? 0 : d) + r })),
            f &&
              l &&
              ((d = g - q),
              f.attr({ height: Math.abs(d), y: (0 < d ? 0 : d) + q })),
          ...
          if (this.hasDragged || d)
            b.axes.forEach(function(b) {
              if (
                b.zoomEnabled &&
                q(b.min) &&
                (d || c[{ xAxis: "zoomX", yAxis: "zoomY" }[b.coll]])
              ) {
                var f = b.horiz,
      ...
      onContainerClick: function(a) {
        ...
        c.cancelClick ||
          (b && this.inClass(a.target, "highcharts-tracker")
            ? (v(b.series, "click", t(a, { point: b })),
              c.hoverPoint && b.firePointEvent("click", a))
            : (t(a, this.getCoordinates(a)),
              c.isInsidePlot(a.chartX - d, a.chartY - g) && v(c, "click", a)));
      },
      setDOMEvents: function() {
        ...
        a.unbindDocumentMouseUp ||
          (a.unbindDocumentMouseUp = C(d, "mouseup", b.onDocumentMouseUp));
        a.hasTouch &&
  ...
  K(G, "parts/TouchPointer.js", [G["parts/Globals.js"]], function(a) {
    ...
    I(a.Pointer.prototype, {
      pinchTranslate: function(a, k, t, u, v, p) {
      ...
      pinchTranslateDirection: function(a, k, t, u, v, p, h, d) {
        ...
        k < n.min
          ? ((k = n.min), (r = !0))
          : k + z > n.max && ((k = n.max - z), (r = !0));
        r
          ? ((E -= 0.8 * (E - h[b][0])), x || (f -= 0.8 * (f - h[b][1])), t())
          : (h[b] = [E, f]);
        A || ((p[b] = q - w), (p[c] = z));
        p = A ? 1 / D : D;
        v[c] = z;
      ...
      pinch: function(a) {
        var e = this,
          ...
          g =
            1 === p &&
            ((e.inClass(a.target, "highcharts-tracker") && t.runTrackerClick) ||
              e.runChartClick),
          l = {};
        1 < p && (e.initiated = !0);
        ...
        "touchstart" === a.type
          ? ([].forEach.call(v, function(a, b) {
              u[b] = { chartX: a.chartX, chartY: a.chartY };
            }),
            (h.x = [u[0].chartX, u[1] && u[1].chartX]),
            (h.y = [u[0].chartY, u[1] && u[1].chartY]),
            ...
            (e.res = !0))
          : e.followTouchMove && 1 === p
          ? this.runPointActions(e.normalize(a))
          : u.length &&
            (m ||
              (e.selectionMarker = m = I({ destroy: F, touch: !0 }, t.plotBox)),
            e.pinchTranslate(u, v, b, m, l, h),
            (e.hasPinched = d),
            e.scaleGroups(b, l),
      ...
      touch: function(e, q) {
        ...
        1 === e.touches.length
          ? ((e = this.normalize(e)),
            (v = t.isInsidePlot(e.chartX - t.plotLeft, e.chartY - t.plotTop)) &&
            !t.openMenu
  ...
  K(G, "parts/Legend.js", [G["parts/Globals.js"]], function(a) {
    ...
    a.Legend.prototype = {
      ...
      colorizeItem: function(a, d) {
        ...
        if (!this.chart.styledMode) {
          ...
          h &&
            (p &&
              h.isMarker &&
              ((n = a.pointAttribs()), d || (n.stroke = n.fill = m)),
            h.attr(n));
        }
        ...
        a &&
          ...
          this.allItems.forEach(function(b) {
            var g = b.checkbox,
              h;
            g &&
              ((h = d + c + g.y + (this.scrollOffset || 0) + 3),
              I(g, {
                left: a.translateX + b.checkboxOffset + g.x - 20 + "px",
                top: h + "px",
                display:
                  this.proximate || (h > d - 6 && h < d + e - 6) ? "" : "none"
              }));
          }, this));
      },
      ...
      setText: function(b) {
        ...
        b.legendItem.attr({
          text: d.labelFormat
            ? a.format(d.labelFormat, b, this.chart.time)
            : d.labelFormatter.call(b)
        });
      },
      renderItem: function(a) {
        ...
        x ||
          ...
          (a.legendItem = x = d.text(
            "",
            n ? e + h : -h,
            this.baseline || 0,
            f
          )),
          b.styledMode || x.css(u(a.visible ? m : k)),
          x.attr({ align: n ? "left" : "right", zIndex: 2 }).add(a.legendGroup),
          this.baseline ||
            ((this.fontMetrics = d.fontMetrics(
              b.styledMode ? 12 : m.fontSize,
              x
            )),
          ...
          this.setItemEvents && this.setItemEvents(a, x, f));
        H && !a.checkbox && this.createCheckboxForItem(a);
        this.colorizeItem(a, a.visible);
        (!b.styledMode && m.width) ||
          x.css({
        ...
        a.itemWidth = a.checkboxOffset =
          c.itemWidth || a.legendItemWidth || b.width + p;
      ...
      layoutItem: function(a) {
        var b = this.options,
          ...
          b =
            b.alignColumns && this.totalItemWidth > p
              ? this.maxItemWidth
              : a.itemWidth;
        c &&
          this.itemX - d + b > p &&
          ((this.itemX = d),
          this.lastLineHeight && (this.itemY += m + this.lastLineHeight + h),
        ...
        c
          ? (this.itemX += b)
          : ((this.itemY += m + e + h), (this.lastLineHeight = e));
        this.offsetWidth =
          this.widthOption ||
          Math.max(
            (c ? this.itemX - d - (a.checkbox ? 0 : k) : b) + d,
            this.offsetWidth
          );
      },
      getAllItems: function() {
        ...
        this.chart.series.forEach(function(b) {
          var d = b && b.options;
          b &&
            v(d.showInLegend, k(d.linkedTo) ? !1 : void 0, !0) &&
            (a = a.concat(
      ...
      adjustMargins: function(a, d) {
        var b = this.chart,
          ...
          g = this.getAlignment(),
          e =
            void 0 !== b.options.title.margin
              ? b.titleOffset + b.options.title.margin
              : 0;
        g &&
          [
            /(lth|ct|rth)/,
            ...
            h.test(g) &&
              ...
              (b[t[l]] = Math.max(
                b[t[l]],
                b.legend[(l + 1) % 2 ? "legendHeight" : "legendWidth"] +
                  [1, -1, -1, 1][l] * c[l % 2 ? "x" : "y"] +
                  v(c.margin, 12) +
                  d[l] +
                  (0 === l && (0 === b.titleOffset ? 0 : e))
              ));
          });
      },
      proximatePositions: function() {
        ...
        this.allItems.forEach(function(c) {
          ...
          c.yAxis &&
            ...
            (g = a.find(h ? c.points : c.points.slice(0).reverse(), function(
              b
            ) {
              return a.isNumber(b.plotY);
            })),
            (h = c.legendGroup.getBBox().height),
            (l = c.yAxis.top - b.plotTop),
            c.visible
              ? ((g = g ? g.plotY : c.yAxis.height), (g += l - 0.3 * h))
              : (g = l + c.yAxis.height),
      ...
      handleOverflow: function(a) {
        ...
        f.length = 0;
        a > h && !1 !== x.enabled
          ? ((this.clipHeight = p = Math.max(h - 20 - this.titleHeight - m, 0)),
            ...
            n ||
              ((n = b.clipRect = c.clipRect(0, m, 9999, 0)),
            ...
            H ||
              ((this.nav = H = c
                ...
                .attr({ zIndex: 1 })
                .add(this.group)),
              (this.up = c.symbol("triangle", 0, 0, E, E).add(H)),
              L("upTracker").on("click", function() {
                b.scroll(-1, B);
              }),
              (this.pager = c
                .text("", 15, 10)
              ...
              this.pager.add(H),
              (this.down = c.symbol("triangle-down", 0, 0, E, E).add(H)),
              L("downTracker").on("click", function() {
                b.scroll(1, B);
              })),
            b.scroll(0),
            (a = h))
      ...
      scroll: function(a, d) {
        ...
        0 < e &&
          ...
          this.chart.styledMode ||
            (this.up.attr({ fill: 1 === e ? g.inactiveColor : g.activeColor }),
            this.upTracker.css({ cursor: 1 === e ? "default" : "pointer" }),
            this.down.attr({ fill: e === c ? g.inactiveColor : g.activeColor }),
            this.downTracker.css({ cursor: e === c ? "default" : "pointer" })),
          (this.scrollOffset = -b[e - 1] + this.initialItemY),
    ...
    a.LegendSymbolMixin = {
      drawRectangle: function(a, d) {
        ...
        d.legendSymbol = this.chart.renderer
          .rect(
            c ? (a.symbolWidth - b) / 2 : 0,
            a.baseline - b + 1,
            c ? b : a.symbolWidth,
            b,
            v(a.options.symbolRadius, b / 2)
          )
      ...
      drawLineMarker: function(a) {
        ...
        d &&
          !1 !== d.enabled &&
          c &&
          ((b = Math.min(v(d.radius, h), h)),
          0 === this.symbol.indexOf("url") &&
            ((d = u(d, { width: e, height: e })), (b = 0)),
          (this.legendSymbol = d = m
            .symbol(this.symbol, c / 2 - b, a - b, 2 * b, 2 * b, d)
            .addClass("highcharts-point")
            .add(k)),
          (d.isMarker = !0));
      }
    ...
    m(M.prototype, {
      ...
      init: function(b, d) {
        ...
        g(this, "init", { args: arguments }, function() {
          ...
          this.series = [];
          this.time =
            b.time && Object.keys(b.time).length ? new a.Time(b.time) : a.time;
        ...
        d.forEach(function(a) {
          a.isDirty &&
            ("point" === a.options.legendType
              ...
              : n && (n.labelFormatter || n.labelFormat) && (h = !0));
      ...
      setTitle: function(a, b, c) {
        ...
        g = f.title = D(
          !e && {
            style: { color: "#333333", fontSize: f.isStock ? "16px" : "18px" }
          },
          f.title,
          a
        );
      ...
      layOutTitles: function(a) {
        ...
        ["title", "subtitle"].forEach(function(a) {
          ...
          var g;
          c &&
            (this.styledMode || (g = e.style.fontSize),
            (g = d.fontMetrics(g, c).b),
            c
              .css({ width: (e.width || f.width + e.widthAdjust) + "px" })
              .align(m({ y: a + g }, e), !1, "spacingBox"),
            e.floating ||
              e.verticalAlign ||
              (b = Math.ceil(b + c.getBBox(e.useHTML).height)));
        }, this);
        ...
        !this.isDirtyBox &&
          ...
          this.hasRendered && x(a, !0) && this.isDirtyBox && this.redraw());
      },
        ...
        if (b)
          for (; c && c.style; )
            c.hcOrigStyle && (a.css(c, c.hcOrigStyle), delete c.hcOrigStyle),
              c.hcOrigDetached &&
                (e.body.removeChild(c), (c.hcOrigDetached = !1)),
              (c = c.parentNode);
        else
          for (; c && c.style; ) {
            e.body.contains(c) ||
              c.parentNode ||
              ((c.hcOrigDetached = !0), e.body.appendChild(c));
      ...
      getContainer: function() {
        ...
        this.renderer = new (a[d.renderer] || a.Renderer)(
          b,
          f,
          n,
          null,
      ...
      reflow: function(b) {
        ...
        if (!n && !c.isPrinting && h && f && (g === N || g === e)) {
          if (h !== c.containerWidth || f !== c.containerHeight)
            a.clearTimeout(c.reflowTimeout),
              (c.reflowTimeout = r(
                function() {
      ...
      setChartSize: function(a) {
        ...
        this.plotHeight = r = Math.max(
          0,
          Math.round(d - m - this.marginBottom)
        );
        ...
        this.clipBox = {
          ...
          height: Math.max(
            0,
            Math.floor(this.plotSizeY - Math.max(f, h[2]) / 2 - c)
          )
        };
        a ||
      ...
      drawChartBox: function() {
        ...
        if (l) h = k = d.strokeWidth();
          ...
          x = { fill: x || "none" };
          if (h || d["stroke-width"])
            (x.stroke = a.borderColor), (x["stroke-width"] = h);
        ...
        e[t](z);
        l ||
          (e.attr({ fill: r || "none" }).shadow(a.plotShadow),
          B &&
            (m
              ? m.animate(z)
              : (this.plotBGImage = b.image(B, p, E, w, H).add())));
        A
          ? A.animate({ width: q.width, height: q.height })
      ...
      linkSeries: function() {
        ...
        b.forEach(function(b) {
          ...
          w(c) &&
            ...
            (b.linkedParent = c),
            (b.visible = x(b.options.visible, c.options.visible, b.visible)));
        });
  ...
  K(G, "parts/ScrollablePlotArea.js", [G["parts/Globals.js"]], function(a) {
    ...
    I.prototype.moveFixedElements = function() {
      ...
      [
        ...
        [].forEach.call(a.querySelectorAll(e), function(a) {
          (a.namespaceURI === k.SVG_NS ? k.box : k.box.parentNode).appendChild(
            a
          );
    ...
    I.prototype.applyFixed = function() {
      ...
      k &&
        ...
        (this.scrollableMask = F.path()
          .attr({
            fill: a
              .color(this.options.chart.backgroundColor || "#fff")
              .setOpacity(a.pick(e.opacity, 0.85))
              .get(),
            zIndex: -1
          })
        ...
        C(this, "afterShowResetZoom", this.moveFixedElements));
    ...
    a.Point.prototype = {
      ...
      applyOptions: function(a, e) {
        ...
        "name" in this &&
          ...
          b.xAxis &&
          b.xAxis.hasNames &&
          (this.x = b.xAxis.nameToX(this));
        void 0 === this.x &&
          b &&
          (this.x = void 0 === e ? b.autoIncrement(this) : e);
        return this;
      },
      ...
      optionsToObject: function(d) {
        ...
        if (t(d) || null === d) e[h[0]] = d;
          ...
          for (
            ...
            d.length > c &&
            ((b = typeof d[0]),
            "string" === b ? (e.name = d[0]) : "number" === b && (e.x = d[0]),
            k++);
            p < c;
            ...
            (g && void 0 === d[k]) ||
              (0 < h[p].indexOf(".")
                ? a.Point.prototype.setNestedProperty(e, d[k], h[p])
                : (e[h[p]] = d[k])),
              k++,
              p++;
        else
    ...
    a.Series = a.seriesType(
      ...
      },
      {
        ...
        init: function(a, b) {
          ...
          e = b.events;
          l(e, function(a, b) {
            (d.hcEvents && d.hcEvents[b] && -1 !== d.hcEvents[b].indexOf(a)) ||
              C(d, b, a);
          });
          if (
            (e && e.click) ||
        ...
        autoIncrement: function() {
          ...
          e &&
            ((a = new g.Date(b)),
            "day" === e
              ? g.set("Date", a, g.get("Date", a) + d)
              : "month" === e
              ? g.set("Month", a, g.get("Month", a) + d)
              : "year" === e && g.set("FullYear", a, g.get("FullYear", a) + d),
            (d = a.getTime() - b));
          this.xIncrement = b + d;
          return b;
        },
        setOptions: function(a) {
          ...
          (!b.negativeColor && !b.negativeFillColor) ||
            ...
            a ||
              ((e.color = b.negativeColor),
              (e.fillColor = b.negativeFillColor)),
            d.push(e));
          d.length &&
            u(d[d.length - 1].value) &&
        ...
        findPointIndex: function(a, b) {
          ...
          var d = this.points,
            ...
            f;
          c &&
            ((f = (c = this.chart.get(c)) && c.index),
            void 0 !== f && (e = !0));
          void 0 === f && m(a) && (f = this.xData.indexOf(a, b));
          -1 !== f &&
            void 0 !== f &&
            this.cropped &&
            (f = f >= this.cropStart ? f - this.cropStart : f);
        ...
        updateData: function(b) {
          ...
          b.forEach(function(b, f) {
            ...
            if (k.id || m(r))
              if (
                ((r = this.findPointIndex(k, h)),
                -1 === r || void 0 === r
                  ? e.push(b)
                  : d[r] && b !== c.data[r]
                  ? (d[r].update(b, !1, null, !1),
                    (d[r].touched = !0),
                    n && (h = r + 1))
                  : d[r] && (d[r].touched = !0),
                !l || f !== r || this.hasDerivedData)
              )
                g = !0;
          }, this);
          if (g)
          ...
          if (!v) {
            ...
            if (z && k > z) {
              ...
              for (h = 0; h < k; h++)
                void 0 !== e[h] &&
                  ((B = { series: n }),
                  n.pointClass.prototype.applyOptions.apply(B, [e[h]]),
                  n.updateParallelArrays(B, h));
        ...
        processData: function(b) {
          ...
          p &&
            ...
            (c[e - 1] < A || c[0] > q
              ...
              : this.yData &&
                (c[0] < A || c[e - 1] > q) &&
                ((g = this.cropData(this.xData, this.yData, A, q)),
                (c = g.xData),
                (d = g.yData),
                (g = g.start),
                (f = !0)));
          for (l = c.length || 1; --l; )
            (e = w ? m(c[l]) - m(c[l - 1]) : c[l] - c[l - 1]),
              0 < e && (void 0 === h || e < h)
                ? (h = e)
                : 0 > e && z && (a.error(15, !1, this.chart), (z = !1));
          this.cropped = f;
          this.cropStart = g;
        ...
        generatePoints: function() {
          ...
          for (t = 0; t < l; t++)
            (k = m + t),
              w
                ? ((A = new g().init(this, [e[t]].concat(z(f[t])))),
                  (A.dataGroup = this.groupMap[t]),
                  A.dataGroup.options &&
                    ((A.options = A.dataGroup.options),
                    p(A, A.dataGroup.options),
                    delete A.dataLabels))
                : (A = c[k]) ||
                  void 0 === b[k] ||
                  (c[k] = A = new g().init(this, b[k], e[t])),
              A && ((A.index = k), (q[t] = A));
          this.options.keys = a;
          if (c && (l !== (d = c.length) || w))
            for (t = 0; t < d; t++)
        ...
        getExtremes: function(a) {
          ...
          for (q = 0; q < e; q++)
            if (
              ...
              (p =
                (m(z, !0) || d(z)) &&
                (!b.positiveValuesOnly || z.length || 0 < z)),
              (w =
          ...
          for (w = 0; w < r; w++) {
            ...
            var V = G.low,
              Q =
                b &&
                k.stacks[
                  (this.negStacks && v < (t ? 0 : q) ? "-" : "") + this.stackKey
                ],
              W,
              X;
            ...
            G.plotX = D = e(
              Math.min(
                Math.max(
                  -1e5,
                  g.translate(K, 0, 0, 0, 1, A, "flags" === this.type)
                ),
                1e5
              )
            );
            b &&
              ...
              Q &&
              Q[K] &&
              ((C = this.getStackIndicator(C, K, this.index)),
              (W = Q[K]),
              (X = W.points[C.key]));
            d(X) &&
              ((V = X[0]),
              (v = X[1]),
              V === t && C.key === Q[K].base && (V = c(m(q) && q, k.min)),
              k.positiveValuesOnly && 0 >= V && (V = null),
              (G.total = G.stackTotal = W.total),
              (G.percentage = W.total && (G.y / W.total) * 100),
              (G.stackY = v),
              W.setOffset(this.pointXOffset || 0, this.barW || 0));
            G.yBottom = u(V)
              ? Math.min(Math.max(-1e5, k.translate(V, 0, 1, 0, 1)), 1e5)
              : null;
            p && (v = this.modifyValue(v, G));
            G.plotY = v =
              "number" === typeof v && Infinity !== v
                ? Math.min(Math.max(-1e5, k.translate(v, 0, 1, 0, 1)), 1e5)
                : void 0;
            G.isInside =
              void 0 !== v && 0 <= v && v <= k.len && 0 <= D && D <= g.len;
            G.clientX = z ? e(g.translate(K, 0, 0, 0, 1, A)) : D;
            G.negative = G[F] < (a[F + "Threshold"] || q || 0);
            G.category = l && void 0 !== l[G.x] ? l[G.x] : G.x;
            G.isNull ||
              (void 0 !== J && (I = Math.min(I, Math.abs(D - J))), (J = D));
        ...
        animate: function(a) {
          ...
          a
            ...
            : ((d = this.sharedClipKey),
              ...
              b[d + "m"] &&
                b[d + "m"].animate(
                  { width: b.plotSizeX + 99, x: b.inverted ? 0 : -99 },
                  c
                ),
              (this.animate = null));
        },
        ...
        drawPoints: function() {
          ...
          var A,
            z = c(
              l.enabled,
              !d || d.isRadial ? !0 : null,
              this.closestPointRangePx >= l.enabledThreshold * l.radius
            );
          if (!1 !== l.enabled || this._hasPointMarkers)
            for (d = 0; d < a.length; d++)
              if (
                ((e = a[d]),
                (h = (f = e.graphic) ? "animate" : "attr"),
                (m = e.marker || {}),
                (k = !!e.marker),
                (g = (z && void 0 === m.enabled) || m.enabled),
                (p = !1 !== e.isInside),
                g && !e.isNull)
              ) {
                ...
                f
                  ? f[p ? "show" : "hide"](!0).animate(A)
                  : p &&
                    (0 < A.width || e.hasImage) &&
                    (e.graphic = f = b.renderer
                      .symbol(g, A.x, A.y, A.width, A.height, k ? m : l)
                      .add(w));
                if (f && !b.styledMode)
        ...
        pointAttribs: function(a, b) {
          ...
          b &&
            ...
            (e = c(
              b.lineWidth,
              d.lineWidth,
              e + c(b.lineWidthPlus, d.lineWidthPlus, 0)
            )),
        ...
        destroy: function(b) {
          ...
          (c.axisTypes || []).forEach(function(a) {
            (k = c[a]) &&
              k.series &&
              (v(k.series, c), (k.isDirty = k.forceRedraw = !0));
          });
        ...
        applyZones: function() {
          ...
          e.length &&
            ...
            e.forEach(function(e, n) {
              ...
              f = Math.min(
                Math.max(Math.round(w.toPixels(c(e.value, A.max), !0) || 0), 0),
                p
              );
              ...
              v = Math.max(g, f);
              w.isXAxis
                ? ((l = { x: q ? v : u, y: 0, width: D, height: p }),
                  t || (l.x = b.plotHeight - l.x))
                : ((l = { x: 0, y: q ? v : u, width: p, height: D }),
                  t && (l.y = b.plotWidth - l.y));
              q &&
                d.isVML &&
                (l = w.isXAxis
                  ? { x: 0, y: z ? u : v, height: l.width, width: b.chartWidth }
                  : {
              ...
              h[n]
                ? h[n].animate(l)
                : ((h[n] = d.clipRect(l)),
                  m && a["zone-graph-" + n].clip(h[n]),
                  k && a["zone-area-" + n].clip(h[n]));
              J = e.value > A.max;
  ...
  K(G, "parts/Stacking.js", [G["parts/Globals.js"]], function(a) {
    ...
    a.StackItem.prototype = {
      ...
      setOffset: function(a, e) {
        ...
        (e = this.label) &&
          d &&
          (e.align(this.alignOptions, null, d),
          (d = e.alignAttr),
          e[
            !1 === this.options.crop || h.isInsidePlot(d.x, d.y)
              ? "show"
              : "hide"
          ](!0));
      },
    ...
    v.prototype.setStackedPoints = function() {
      if (
        ...
        for (f = 0; f < m; f++)
          (r = e[f]),
            (C = h[f]),
            (x = this.getStackIndicator(x, r, this.index)),
            (v = x.key),
            (E = (B = q && C < (l ? 0 : g)) ? z : w),
            A[E] || (A[E] = {}),
            A[E][r] ||
              (n[E] && n[E][r]
                ? ((A[E][r] = n[E][r]), (A[E][r].total = null))
                : (A[E][r] = new a.StackItem(
                    t,
            ...
            (E = A[E][r]),
            null !== C
              ? ((E.points[v] = E.points[this.index] = [u(E.cumulative, l)]),
                k(E.cumulative) || (E.base = v),
                (E.touched = t.stacksTouched),
                0 < x.index &&
                  !1 === this.singleStacks &&
                  (E.points[v][0] = E.points[this.index + "," + r + ",0"][0]))
              : (E.points[v] = E.points[this.index] = null),
            "percent" === b
              ? ((B = B ? w : z),
                q && A[B] && A[B][r]
                  ? ((B = A[B][r]),
                    (E.total = B.total =
                      Math.max(B.total, E.total) + Math.abs(C) || 0))
                  : (E.total = F(E.total + (Math.abs(C) || 0))))
              : (E.total = F(E.total + (C || 0))),
            (E.cumulative = u(E.cumulative, l) + (C || 0)),
            null !== C &&
              (E.points[v].push(E.cumulative), (d[f] = E.cumulative));
      ...
      a[g + "Stacker"] &&
        [e, "-" + e].forEach(function(e) {
          for (var c = m.length, h, l; c--; )
            if (
              ((h = m[c]),
              (b = a.getStackIndicator(b, h, a.index, e)),
              (l = (h = d[e] && d[e][h]) && h.points[b.key]))
            )
              a[g + "Stacker"](l, h, c);
        });
    };
  ...
  K(G, "parts/Dynamics.js", [G["parts/Globals.js"]], function(a) {
    ...
    a.cleanRecursively = function(b, c) {
      ...
      g(b, function(g, h) {
        if (d(b[h], !0) && c[h])
          (g = a.cleanRecursively(b[h], c[h])),
            Object.keys(g).length && (e[h] = g);
    ...
    v(k.prototype, {
      addSeries: function(a, b, c) {
        ...
        a &&
          ((b = l(b, !0)),
          p(e, "addSeries", { options: a }, function() {
            d = e.initSeries(a);
            e.isDirtyLegend = !0;
            e.linkSeries();
      ...
      update: function(c, d, e, m) {
        ...
        g(c, function(a, b) {
          ...
          "chart" !== b &&
            -1 !== k.propsRequireUpdateSeries.indexOf(b) &&
            (w = !0);
        });
        this.collectionsWithUpdate.forEach(function(a) {
          ...
          c[a] &&
            ...
            D(c[a]).forEach(function(c, d) {
              (d = (t(c.id) && k.get(c.id)) || k[a][b ? b[d] : d]) &&
                d.coll === a &&
                (d.update(c, !1), e && (d.touched = !0));
              if (!d && e)
                if ("series" === a) k.addSeries(c, !1).touched = !0;
                else if ("xAxis" === a || "yAxis" === a)
                  k.addAxis(c, "xAxis" === a, !1).touched = !0;
            }),
            e &&
        ...
        z || (h(r) && r !== k.chartWidth) || (h(f) && f !== k.chartHeight)
          ? k.setSize(r, f, m)
          : l(d, !0) && k.redraw(m);
    ...
    v(c.prototype, {
      update: function(a, b, c, e) {
        function g() {
          ...
          p.data[m] =
            d(p.data[m], !0) || d(a, !0) ? h.options : l(a, p.data[m]);
    ...
    v(w.prototype, {
      addPoint: function(a, b, c, d, e) {
        ...
        x = n.x;
        q = z.length;
        if (this.requireSorting && x < z[q - 1])
          for (w = !0; q && z[q - 1] > x; ) q--;
      ...
      update: function(c, d) {
        ...
        n &&
          ...
          !1 === k.visible
            ...
            : (k.marker && !1 === k.marker.enabled && (u.graphic = 1),
              k.dataLabels && !1 === k.dataLabels.enabled && (u.dataLabel = 1)),
          this.points.forEach(function(a) {
            a &&
              a.series &&
              (a.resolveColor(),
              Object.keys(u).length && a.destroyElements(u),
      ...
      { softThreshold: !1, threshold: 0 },
      {
        ...
        getGraphPath: function(a) {
          var e = F.prototype.getGraphPath,
            ...
            J = function(e, h, k) {
              ...
              var z,
                ...
                n = !0;
              k || p
                ? ((z = (p ? e[0] : e[1]) + k), (q = e[0] + k), (n = !!p))
                : !u && a[h] && a[h].isNull && (z = q = c);
              void 0 !== z &&
                (m.push({
                  plotX: g,
          ...
          for (p = 0; p < a.length; p++)
            if (
              ((h = a[p].isNull),
              (g = I(a[p].rectPlotX, a[p].plotX)),
              (z = I(a[p].yBottom, w)),
              !h || k)
            )
              k || J(p, p - 1, "left"),
                (h && !u && k) ||
                  (m.push(a[p]), d.push({ x: p, plotX: g, plotY: z })),
                k || J(p, p + 1, "right");
          p = e.call(this, m, !0, !0);
          d.reversed = !0;
          h = e.call(this, d, !0, !0);
        ...
        drawGraph: function() {
          ...
          this.zones.forEach(function(e, k) {
            u.push([
              "zone-area-" + k,
              "highcharts-area highcharts-zone-area-" + k + " " + e.className,
              e.color || a.color,
          ...
          u.forEach(function(e) {
            var p = e[0],
              ...
              m = {};
            h
              ? ((h.endX = a.preventGraphAnimation ? null : k.xMap),
                h.animate({ d: k }))
              : ((m.zIndex = 0),
                (h = a[p] = a.chart.renderer
                  .path(k)
                  .addClass(e[1])
                  .add(a.group)),
                (h.isArea = !0));
            a.chart.styledMode ||
              (m.fill = I(
                e[3],
                C(e[2])
                  .setOpacity(I(t.fillOpacity, 0.75))
                  .get()
              ));
            h[d](m);
            h.startX = k.xMap;
      ...
      {},
      {
        getPointSpline: function(a, F, k) {
          ...
          if (
            ...
            h += d;
            v > a && v > q
              ? ((v = Math.max(a, q)), (h = 2 * q - v))
              : v < a && v < q && ((v = Math.min(a, q)), (h = 2 * q - v));
            h > k && h > q
              ? ((h = Math.max(k, q)), (v = 2 * q - h))
              : h < k && h < q && ((h = Math.min(k, q)), (v = 2 * q - h));
            F.rightContX = p;
            F.rightContY = h;
          }
          F = [
            "C",
            C(t.rightContX, t.plotX),
            C(t.rightContY, t.plotY),
            C(u, e),
            C(v, q),
            e,
            q
      ...
      },
      {
        ...
        getColumnMetrics: function() {
          ...
          var z = Math.min(
            ...
            d = Math.min(
              ...
              t(d.pointWidth, u * (1 - 2 * d.pointPadding))
            );
          a.columnMetrics = {
            width: d,
            offset:
              (u - d) / 2 +
              (q + ((a.columnIndex || 0) + (g ? 1 : 0)) * u - z / 2) *
                (g ? -1 : 1)
          };
        ...
        translate: function() {
          ...
          a.points.forEach(function(b) {
            ...
            p &&
              Math.abs(w) < p &&
              ((w = p),
              (z = (!g.reversed && !b.negative) || (g.reversed && b.negative)),
              b.y === l && a.dataMax <= l && g.min < l && (z = !z),
              (r = Math.abs(r - c) > p ? e - p : c - (z ? p : 0)));
            k(b.options.pointWidth) &&
              ((m = f = Math.ceil(b.options.pointWidth)),
              (n -= Math.round((m - q) / 2)));
            b.barX = n;
            b.pointWidth = m;
            b.tooltipPos = d.inverted
              ? [g.len + g.pos - d.plotLeft - h, a.xAxis.len - n - f / 2, w]
              : [n + f / 2, h + g.pos - d.plotTop, w];
            b.shapeType = a.pointClass.prototype.shapeType || "rect";
            b.shapeArgs = a.crispCol.apply(
              a,
              b.isNull ? [n, c, f, 0] : [n, r, f, w]
            );
          });
        },
        getSymbol: a.noop,
        ...
        pointAttribs: function(a, d) {
          ...
          a &&
            this.zones.length &&
            ((D = a.getZone()),
            (c = a.options.color || (D && D.color) || this.color),
            D &&
              ((k = D.borderColor || k),
              (g = D.dashStyle || g),
              (p = D.borderWidth || p)));
        ...
        drawPoints: function() {
          ...
          a.points.forEach(function(c) {
            ...
            if (e(c.plotY) && null !== c.y) {
              ...
              if (h) h[m](q(l));
              else c.graphic = h = b[c.shapeType](l).add(c.group || a.group);
              if (k.borderRadius) h[m]({ r: k.borderRadius });
              d.styledMode ||
                h[m](a.pointAttribs(c, c.selected && "select")).shadow(
                  !1 !== c.allowShadow && k.shadow,
                  null,
          ...
          p &&
            (a
              ? ((h.scaleY = 0.001),
                (a = Math.min(
                  e.pos + e.len,
                  Math.max(e.pos, e.toPixels(b.threshold))
                )),
                g ? (h.translateX = a - e.len) : (h.translateY = a),
                d.clipBox && d.setClip(),
                d.group.attr(h))
              : ((k = d.group.attr(c)),
                d.group.animate(
    ...
    I(
      ...
      },
      {
        ...
        applyJitter: function() {
          ...
          k &&
            this.points.forEach(function(q, t) {
              ["x", "y"].forEach(function(u, v) {
                ...
                k[u] &&
                  ...
                  p &&
                    !p.isLog &&
                    ((d = Math.max(0, q[h] - m)),
                    (p = Math.min(p.len, q[h] + m)),
                    (v = 1e4 * Math.sin(t + v * e)),
                    (q[h] = d + (p - d) * (v - Math.floor(v))),
    ...
    p(
      ...
      },
      {
          ...
          a ||
            (b.forEach(function(a) {
              var b = a.graphic,
                g = a.shapeArgs;
              b &&
                (b.attr({ r: a.startR || d.center[3] / 2, start: e, end: e }),
                b.animate(
        ...
        updateTotals: function() {
          ...
          for (a = 0; a < g; a++)
            (h = b[a]),
              (h.percentage = 0 < e && (h.visible || !c) ? (h.y / e) * 100 : 0),
              (h.total = e);
        },
        generatePoints: function() {
        ...
        getX: function(a, e, b) {
          ...
          return (
            ...
            (e ? -1 : 1) *
              Math.cos(
                Math.asin(
                  Math.max(Math.min((a - d[1]) / (h + b.labelDistance), 1), -1)
                )
              ) *
              (h + b.labelDistance) +
            (0 < b.labelDistance
        ...
        translate: function(a) {
          ...
          for (v = 0; v < E; v++) {
            H = u[v];
            H.labelDistance = t(
              H.options.dataLabels && H.options.dataLabels.distance,
              x
            );
            ...
            A = (Math.cos(p) * a[2]) / 2;
            n = (Math.sin(p) * a[2]) / 2;
            H.tooltipPos = [a[0] + 0.7 * A, a[1] + 0.7 * n];
            ...
            H.labelPosition = {
              ...
              final: {},
              alignment:
                0 > H.labelDistance ? "center" : H.half ? "right" : "left",
              connectorPosition: {
                breakAt: {
          ...
          a.points.forEach(function(d) {
            ...
            if (!d.isNull && k) {
              ...
              if (!h.styledMode) {
                ...
                z &&
                  !m &&
                  (m = d.shadowGroup = b.g("shadow").add(a.shadowGroup));
                m && m.attr(g);
                ...
                ? (k
                  ...
                  h.styledMode ||
                    k
                      ...
                      .shadow(z, m),
                  (d.delayRendering = !1))
                : (k.setRadialReference(a.center),
                  h.styledMode || e(!0, l, c),
                  e(!0, l, p, g),
                  k.animate(l));
      ...
      },
      {
        ...
        setVisible: function(a, e) {
          ...
          a !== b.visible &&
            ...
            b.legendItem && h.legend.colorizeItem(b, a),
        ...
        haloPath: function(a) {
          ...
          return this.sliced || !this.visible
            ...
            : this.series.chart.renderer.symbols.arc(
                ...
                d.r + a,
                d.r + a,
                { innerR: this.shapeArgs.r - 1, start: d.start, end: d.end }
              );
        },
        connectorShapes: {
  ...
  K(G, "parts/DataLabels.js", [G["parts/Globals.js"]], function(a) {
    ...
    a.distribute = function(b, d, e) {
      ...
      for (
        b = b.map(function(a) {
          return { size: a.size, targets: [a.target], align: t(a.align, 0.5) };
        });
        k;
        ...
        for (g = b.length; g--; )
          (k = b[g]),
            (p =
              ...
              2),
            (k.pos = Math.min(Math.max(0, p - k.size * k.align), d - k.size));
        g = b.length;
        for (k = !1; g--; )
          0 < g &&
            ...
            (b[g - 1].align = 0.5),
            b[g - 1].pos + b[g - 1].size > d &&
              (b[g - 1].pos = d - b[g - 1].size),
            b.splice(g, 1),
            (k = !0));
      }
      l.push.apply(l, m);
        ...
        if (
          b.targets.some(function() {
            ...
            if (Math.abs(l[g].pos - l[g].target) > e)
              return (
                l.slice(0, g + 1).forEach(function(a) {
                  delete a.pos;
                }),
                (l.reducedLen = (l.reducedLen || d) - 0.1 * d),
                l.reducedLen > 0.1 * d && a.distribute(l, d, e),
                !0
              );
            c += l[g].size;
            g++;
      ...
      var h = this,
        ...
        q = g(
          g(
            ...
            c.options.plotOptions &&
              c.options.plotOptions[h.type] &&
              c.options.plotOptions[h.type].dataLabels
          ),
          q
        );
        ...
        (n = h.plotGroup(
          ...
          u.forEach(function(d) {
            ...
            D.forEach(function(e, f) {
              ...
              g &&
                ((l = d.getLabelConfig()),
                (m = t(e[d.formatPrefix + "Format"], e.format)),
                (l = I(m)
                  ? k(m, l, c.time)
                  : (e[d.formatPrefix + "Formatter"] || e.formatter).call(
                      l,
                      e
                    )),
                (m = e.style),
                (r = e.rotation),
                c.styledMode ||
                  ((m.color = t(e.color, m.color, h.color, "#000000")),
                  "contrast" === m.color &&
                    ((d.contrastColor = H.getContrast(d.color || h.color)),
                    (m.color =
                      e.inside ||
                      0 > t(e.distance, d.labelDistance) ||
                      p.stacking
                        ? d.contrastColor
                        : "#000000")),
                  p.cursor && (m.cursor = p.cursor)),
                (q = {
                  r: e.borderRadius || 0,
                  rotation: r,
                  padding: e.padding,
                ...
                c.styledMode ||
                  ((q.fill = e.backgroundColor),
                  (q.stroke = e.borderColor),
                ...
                ? g &&
                  ...
                  (z
                    ...
                    : ((d.dataLabels = d.dataLabels || []),
                      (z = d.dataLabels[f] = r
                        ? H.text(l, 0, -9999).addClass("highcharts-data-label")
                        : H.label(
                            l,
                            0,
                            -9999,
                  ...
                  (z.options = e),
                  z.attr(q),
                  c.styledMode || z.css(m).shadow(e.shadow),
                  z.added || z.add(n),
                  e.textPath &&
                    z.setTextPath(
                      (d.getDataLabelPath && d.getDataLabelPath(z)) ||
                        d.graphic,
                      e.textPath
                    ),
                  h.alignDataLabel(d, z, e, null, u))
                : ((d.dataLabel = d.dataLabel && d.dataLabel.destroy()),
                  d.dataLabels &&
    ...
    v.prototype.alignDataLabel = function(a, d, e, c, h) {
      var b = this.chart,
        ...
        u =
          this.visible &&
          (a.series.forceDL ||
            b.isInsidePlot(k, Math.round(l), g) ||
            (c && b.isInsidePlot(k, g ? c.x + 1 : c.y + c.height - 1, g))),
        f = "justify" === t(e.overflow, "justify");
      if (
        u &&
        ((m = b.renderer.fontMetrics(
          b.styledMode ? void 0 : e.style.fontSize,
          d
        ).b),
        (c = F(
          {
        ...
        p
          ? ((f = !1),
            (k = b.renderer.rotCorr(m, p)),
            (k = {
              x: c.x + e.x + c.width / 2 + k.x,
              y:
                c.y +
                e.y +
                { top: 0, middle: 0.5, bottom: 1 }[e.verticalAlign] * c.height
            }),
            d[h ? "attr" : "animate"](k).attr({ align: q }),
            (l = (p + 720) % 360),
            (l = 180 < l && 360 > l),
            "left" === q
              ? (k.y -= l ? n.height : 0)
              ...
              : "right" === q && ((k.x -= n.width), (k.y -= l ? 0 : n.height)),
            (d.placed = !0),
            (d.alignAttr = k))
          : (d.align(e, null, c), (k = d.alignAttr)),
        f && 0 <= c.height
          ? (a.isLabelJustified = this.justifyDataLabel(d, e, k, n, c, h))
          : t(e.crop, !0) &&
            (u =
              b.isInsidePlot(k.x, k.y) &&
              b.isInsidePlot(k.x + n.width, k.y + n.height)),
        e.shape && !p)
      )
        d[h ? "attr" : "animate"]({
    ...
    v.prototype.justifyDataLabel = function(a, d, e, c, h, k) {
      ...
      n = e.x + c.width - p;
      n > b.plotWidth &&
        ("left" === g ? (d.align = "right") : (d.x = b.plotWidth - n),
        (m = !0));
      n = e.y + p;
      0 > n &&
        ("bottom" === l ? (d.verticalAlign = "top") : (d.y = -n), (m = !0));
      n = e.y + c.height - p;
      n > b.plotHeight &&
        ("top" === l ? (d.verticalAlign = "bottom") : (d.y = b.plotHeight - n),
        (m = !0));
      m && ((a.placed = !k), a.align(d, null, h));
      return m;
    };
    p.pie &&
      ((p.pie.prototype.dataLabelPositioners = {
      ...
      (p.pie.prototype.drawDataLabels = function() {
        ...
        b.visible &&
          ...
          v.prototype.drawDataLabels.apply(b),
          d.forEach(function(a) {
            a.dataLabel &&
              (a.visible
                ? (K[a.half].push(a),
          ...
          K.forEach(function(d, e) {
            ...
            if (p)
              for (
                b.sortByAngle(d, e - 0.5),
                  0 < b.maxLabelDistance &&
                    ((g = Math.max(0, f - H - b.maxLabelDistance)),
                    (l = Math.min(f + H + b.maxLabelDistance, c.plotHeight)),
                    d.forEach(function(a) {
                      0 < a.labelDistance &&
                        a.dataLabel &&
                        ((a.top = Math.max(0, f - H - a.labelDistance)),
                        (a.bottom = Math.min(
                          f + H + a.labelDistance,
                          c.plotHeight
                        )),
                ...
                z &&
                  I(h.distributeBox) &&
                  (void 0 === h.distributeBox.pos
                    ? (S = "hidden")
                    : ((L = h.distributeBox.size),
                      (y = T.radialDistributionY(h))));
                ...
                r._pos = {
                  x: O + k.x + ({ left: m, right: -m }[G.alignment] || 0),
                  y: y + k.y - 10
                };
                G.final.x = O;
                G.final.y = y;
                t(k.crop, !0) &&
                  ...
                  (g = null),
                  O - F < m && 1 === e
                    ? ((g = Math.round(F - O + m)), (R[3] = Math.max(g, R[3])))
                    : O + F > q - m &&
                      0 === e &&
                      ((g = Math.round(O + F - q + m)),
                      (R[1] = Math.max(g, R[1]))),
                  0 > y - L / 2
                    ? (R[0] = Math.max(Math.round(-y + L / 2), R[0]))
                    : y + L / 2 > u &&
                      (R[2] = Math.max(Math.round(y + L / 2 - u), R[2])),
                  (r.sideOverflow = g));
              }
          }),
          0 === C(R) || this.verifyDataLabelOverflow(R)) &&
      ...
      (p.pie.prototype.alignDataLabel = q),
      (p.pie.prototype.verifyDataLabelOverflow = function(a) {
        ...
        k ||
          (null !== c[0]
            ? (h = Math.max(b[2] - Math.max(a[1], a[3]), e))
            : ((h = Math.max(b[2] - a[1] - a[3], e)),
              (b[0] += (a[3] - a[1]) / 2)),
          null !== c[1]
            ? (h = Math.max(Math.min(h, b[2] - Math.max(a[0], a[2])), e))
            : ((h = Math.max(Math.min(h, b[2] - a[0] - a[2]), e)),
              (b[1] += (a[0] - a[2]) / 2)),
          h < b[2]
            ? ((b[2] = h),
              (b[3] = Math.min(u(d.innerSize || 0, h), h)),
              this.translate(b),
    ...
    p.column &&
      (p.column.prototype.alignDataLabel = function(a, d, h, c, k) {
        ...
        l &&
          ...
          n ||
            (b
              ? ((c.x += m ? 0 : c.width), (c.width = 0))
              : ((c.y += m ? c.height : 0), (c.height = 0))));
        h.align = t(h.align, !b || n ? "center" : m ? "right" : "left");
        h.verticalAlign = t(
          h.verticalAlign,
          b || n ? "middle" : m ? "top" : "bottom"
        );
          ...
          if (a && (!a.alignAttr || a.placed))
            return (
              ...
              a.width ||
                ...
                (a.width = d.width),
                (a.height = d.height),
                (d = p.fontMetrics(null, a.element).h)),
              {
            ...
            a.oldOpacity !== c &&
              (a.alignAttr && a.placed
                ? (c
                  ...
                  q(e, "afterHideOverlappingLabels"))
                : a.attr({ opacity: c })),
            (a.isOld = !0));
        });
      };
    ...
    w = a.TrackerMixin = {
        ...
        a._hasTracking ||
          (a.trackerGroups.forEach(function(e) {
            if (a[e]) {
              ...
              !b.styledMode &&
                a.options.cursor &&
                a[e].css(k).css({ cursor: a.options.cursor });
            }
          }),
          (a._hasTracking = !0));
      ...
      drawTrackerGraph: function() {
        var a = this,
          ...
          t = "rgba(192,192,192," + (c ? 0.0001 : 0.002) + ")";
        if (g && !d)
          for (p = g + 1; p--; )
            "M" === e[p] && e.splice(p + 1, 0, e[p + 1] - m, e[p + 2], "L"),
              ((p && "M" === e[p]) || p === g) &&
                e.splice(p, 0, "L", e[p - 2] + m, e[p - 1]);
        f
          ? f.attr({ d: e })
          : a.graph &&
            ((a.tracker = l
      ...
      setItemEvents: function(a, c, e) {
        ...
        (e ? c : a.legendGroup)
          ...
          .on("mouseout", function() {
            h.styledMode ||
              c.css(d(a.visible ? h.itemStyle : h.itemHiddenStyle));
            h.allItems.forEach(function(b) {
              a !== b && b.setState("", !k);
            });
            g.removeClass(l);
      ...
      showResetZoom: function() {
        ...
        u(this, "beforeShowResetZoom", null, function() {
          b.resetZoomButton = b.renderer
            .button(c.resetZoom, null, null, a, h, g && g.hover)
      ...
      zoom: function(b) {
        ...
        !b || b.resetSelection
          ...
          : b.xAxis.concat(b.yAxis).forEach(function(b) {
              ...
              e[m ? "zoomX" : "zoomY"] &&
                n &&
                ((d = k.zoom(b.min, b.max)), k.displayBtn && (h = !0));
            });
        k = c.resetZoomButton;
        h && !k
          ? c.showResetZoom()
          : !h && p(k) && (c.resetZoomButton = k.destroy());
        d &&
          c.redraw(
            m(c.options.chart.animation, b && b.animation, 100 > c.pointCount)
          );
      },
      pan: function(a, b) {
        var c = this,
        ...
        u(this, "pan", { originalEvent: a }, function() {
          ...
          ("xy" === b ? [1, 0] : [1]).forEach(function(b) {
            ...
            var d = b.horiz,
              ...
              k = Math.min(
                l.dataMin,
                f ? l.min : b.toValue(b.toPixels(l.min) - b.minPixelPadding)
              ),
              f = Math.max(
                l.dataMax,
                f ? l.max : b.toValue(b.toPixels(l.max) + b.minPixelPadding)
              ),
              n = k - g;
            0 < n && ((m += n), (g = k));
            n = m - f;
            ...
            b.series.length &&
              g !== l.min &&
              m !== l.max &&
              (b.setExtremes(g, m, !1, !1, { trigger: "pan" }), (e = !0));
            c[d] = h;
          });
          e && c.redraw(!1);
      ...
      setState: function(a, b) {
        ...
        if (
          !(
            ...
            !1 === g.enabled ||
            (a && (p || (l && !1 === f.enabled))) ||
            (a && z.states && z.states[a] && !1 === z.states[a].enabled)
          )
        ) {
          this.state = a;
          ...
          if (this.graphic)
            h && this.graphic.removeClass("highcharts-point-" + h),
              ...
              w.styledMode ||
                ((y = e.pointAttribs(this, a)),
                (G = m(w.options.chart.animation, g.animation)),
                e.options.inactiveOtherPoints &&
                  ((this.dataLabels || []).forEach(function(a) {
                    a && a.animate({ opacity: y.opacity }, G);
                  }),
                  this.connector &&
                    this.connector.animate({ opacity: y.opacity }, G)),
                this.graphic.animate(y, G)),
              F &&
                this.graphic.animate(
                  F,
                  m(w.options.chart.animation, f.animation, k.animation)
                ),
              v && v.hide();
          else {
            if (a && f) {
              ...
              if (v) v[b ? "animate" : "attr"]({ x: F.x, y: F.y });
                ...
                h &&
                  ((e.stateMarkerGraphic = v = w.renderer
                    .symbol(h, F.x, F.y, F.width, F.height)
                    .add(e.markerGroup)),
                  (v.currentSymbol = h));
              !w.styledMode && v && v.attr(e.pointAttribs(this, a));
            }
            v &&
              (v[a && w.isInsidePlot(c, d, w.inverted) ? "show" : "hide"](),
          ...
          (a = g.halo) && a.size
            ? (C ||
                (e.halo = C = w.renderer
                  .path()
                  .add((this.graphic || v).parentGroup)),
              C.show()[b ? "animate" : "attr"]({ d: this.haloPath(a.size) }),
              C.attr({
                class:
                  "highcharts-halo highcharts-color-" +
                  m(this.colorIndex, e.colorIndex) +
              ...
              w.styledMode ||
                C.attr(
                  t(
                    { fill: this.color || e.color, "fill-opacity": a.opacity },
                    a.attributes
                  )
                ))
            : C &&
    ...
    t(g.prototype, {
      ...
      setState: function(a, b) {
        ...
        if (
          ...
          a &&
            ((k = g[a].lineWidth || k + (g[a].lineWidthPlus || 0)),
            (l = m(g[a].opacity, l)));
          if (e && !e.dashstyle)
            for (
              g = { "stroke-width": k }, e.animate(g, f);
              c["zone-graph-" + d];
  ...
  K(G, "parts/Responsive.js", [G["parts/Globals.js"]], function(a) {
    ...
    C.prototype.setResponsive = function(e, k) {
      ...
      t = t.toString() || void 0;
      t !== (p && p.ruleIds) &&
        (p && this.update(p.undoOptions, e),
        t
          ? ((p = this.currentOptions(k)),
    ...
    C.prototype.matchResponsiveRule = function(a, e) {
      ...
      (
        ...
        function() {
          return (
            this.chartWidth <= k(q.maxWidth, Number.MAX_VALUE) &&
            this.chartHeight <= k(q.maxHeight, Number.MAX_VALUE) &&
            this.chartWidth >= k(q.minWidth, 0) &&
            this.chartHeight >= k(q.minHeight, 0)
          );
        }
